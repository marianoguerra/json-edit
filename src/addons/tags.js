...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['jquery', 'jqueryui', 'json.edit', 'json.schema', 'nsgen',
               'json', 'jquery.taghandler'],
               function ($, $ui, JsonEdit, JsonSchema, NsGen, JSON, TagHandler) {
            // Also create a global in case some scripts
            // that are loaded still are looking for
            // a global even when an AMD loader is in use.
            return (root.JsonEdit = factory($, $ui, JsonEdit, JsonSchema, NsGen, JSON, TagHandler));
        });
    } else {
        // Browser globals
        root.JsonEdit = factory(root.$, root.$, root.JsonEdit, root.JsonSchema, root.NsGen, root.JSON, root.TagHandler);
    }
}(this, function ($, $ui, JsonEdit, JsonSchema, NsGen, JSON, TagHandler) {
    "use strict";
