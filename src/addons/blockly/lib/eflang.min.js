...
var COMPILED=!0,goog=goog||{};goog.global=this;goog.define=function(a,b){var c=b;COMPILED||goog.global.CLOSURE_DEFINES&&Object.prototype.hasOwnProperty.call(goog.global.CLOSURE_DEFINES,a)&&(c=goog.global.CLOSURE_DEFINES[a]);goog.exportPath_(a,c)};goog.DEBUG=!0;goog.LOCALE="en";goog.TRUSTED_SITE=!0;
...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};goog.events.STRICT_EVENT_TARGET=!0;goog.events.listeners_={};goog.events.listenerTree_={};goog.events.sources_={};goog.events.onString_="on";goog.events.onStringMap_={};goog.events.keySeparator_="_";
...
goog.events.unlistenByKey=function(a){var b=a instanceof goog.events.Listener?a:goog.events.listeners_[a];if(!b||b.removed)return!1;var c=b.src;if(goog.events.Listenable.USE_LISTENABLE_INTERFACE&&goog.events.Listenable.isImplementedBy(c))return c.unlistenByKey(b);var d=b.type,e=b.proxy,f=b.capture;c.removeEventListener?c!=goog.global&&c[goog.events.CUSTOM_EVENT_ATTR]||c.removeEventListener(d,e,f):c.detachEvent&&c.detachEvent(goog.events.getOnString_(d),e);c=goog.getUid(c);goog.events.sources_[c]&&
(e=goog.events.sources_[c],goog.array.remove(e,b),0==e.length&&delete goog.events.sources_[c]);b.removed=!0;if(b=goog.events.listenerTree_[d][f][c])b.needsCleanup_=!0,goog.events.cleanUp_(d,f,c,b);delete goog.events.listeners_[a];return!0};goog.events.unlistenWithWrapper=function(a,b,c,d,e){b.unlisten(a,c,d,e)};goog.events.cleanUp=function(a){delete goog.events.listeners_[a.key]};
...
goog.Timer.TICK="tick";goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};goog.color={};
...
goog.color.colorDiff_=function(a,b){return Math.abs(a[0]-b[0])+Math.abs(a[1]-b[1])+Math.abs(a[2]-b[2])};goog.dom={};goog.dom.BrowserFeature={CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),CAN_USE_CHILDREN_ATTRIBUTE:!goog.userAgent.GECKO&&!goog.userAgent.IE||goog.userAgent.IE&&goog.userAgent.isDocumentModeOrHigher(9)||goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9.1"),CAN_USE_INNER_TEXT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),CAN_USE_PARENT_ELEMENT_PROPERTY:goog.userAgent.IE||goog.userAgent.OPERA||goog.userAgent.WEBKIT,INNER_HTML_NEEDS_SCOPED_ELEMENT:goog.userAgent.IE};goog.dom.TagName={A:"A",ABBR:"ABBR",ACRONYM:"ACRONYM",ADDRESS:"ADDRESS",APPLET:"APPLET",AREA:"AREA",ARTICLE:"ARTICLE",ASIDE:"ASIDE",AUDIO:"AUDIO",B:"B",BASE:"BASE",BASEFONT:"BASEFONT",BDI:"BDI",BDO:"BDO",BIG:"BIG",BLOCKQUOTE:"BLOCKQUOTE",BODY:"BODY",BR:"BR",BUTTON:"BUTTON",CANVAS:"CANVAS",CAPTION:"CAPTION",CENTER:"CENTER",CITE:"CITE",CODE:"CODE",COL:"COL",COLGROUP:"COLGROUP",COMMAND:"COMMAND",DATA:"DATA",DATALIST:"DATALIST",DD:"DD",DEL:"DEL",DETAILS:"DETAILS",DFN:"DFN",DIALOG:"DIALOG",DIR:"DIR",DIV:"DIV",
...
goog.a11y.aria.setActiveDescendant=function(a,b){goog.a11y.aria.setState(a,goog.a11y.aria.State.ACTIVEDESCENDANT,b?b.id:"")};goog.a11y.aria.getLabel=function(a){return goog.a11y.aria.getState(a,goog.a11y.aria.State.LABEL)};goog.a11y.aria.setLabel=function(a,b){goog.a11y.aria.setState(a,goog.a11y.aria.State.LABEL,b)};goog.ui.ControlRenderer=function(){};goog.addSingletonGetter(goog.ui.ControlRenderer);goog.ui.ControlRenderer.getCustomRenderer=function(a,b){var c=new a;c.getCssClass=function(){return b};return c};goog.ui.ControlRenderer.CSS_CLASS="goog-control";goog.ui.ControlRenderer.IE6_CLASS_COMBINATIONS=[];goog.ui.ControlRenderer.prototype.getAriaRole=function(){};
...
Blockly.BlockSvg.prototype.renderCompute_=function(a){var b=this.block_.inputList,c=[];c.rightEdge=a+2*Blockly.BlockSvg.SEP_SPACE_X;if(this.block_.previousConnection||this.block_.nextConnection)c.rightEdge=Math.max(c.rightEdge,Blockly.BlockSvg.NOTCH_WIDTH+Blockly.BlockSvg.SEP_SPACE_X);if(this.block_.collapsed)return c;for(var d=0,e=0,f=!1,g=!1,h=!1,k=void 0,l=0,m;m=b[l];l++){var n;this.block_.inputsInline&&k&&k!=Blockly.NEXT_STATEMENT&&m.type!=Blockly.NEXT_STATEMENT?n=c[c.length-1]:(k=m.type,n=[],
n.type=this.block_.inputsInline&&m.type!=Blockly.NEXT_STATEMENT?Blockly.BlockSvg.INLINE:m.type,n.height=0,c.push(n));n.push(m);m.renderHeight=Blockly.BlockSvg.MIN_BLOCK_Y;m.renderWidth=this.block_.inputsInline&&m.type==Blockly.INPUT_VALUE?Blockly.BlockSvg.TAB_WIDTH+Blockly.BlockSvg.SEP_SPACE_X:0;if(m.connection&&m.connection.targetConnection){var q=m.connection.targetBlock();try{var r=q.getSvgRoot().getBBox()}catch(p){r={height:0,width:0}}Blockly.BROKEN_CONTROL_POINTS&&(r.height-=10,q.nextConnection&&
(r.height+=4));m.renderHeight=Math.max(m.renderHeight,r.height-1);m.renderWidth=Math.max(m.renderWidth,r.width)}n.height=Math.max(n.height,m.renderHeight);m.titleWidth=0;1==c.length&&(m.titleWidth+=Blockly.RTL?-a:a);for(var q=0,s;s=m.titleRow[q];q++)0!=q&&(m.titleWidth+=Blockly.BlockSvg.SEP_SPACE_X),s=s.getSize(),m.titleWidth+=s.width,n.height=Math.max(n.height,s.height);n.type!=Blockly.BlockSvg.INLINE&&(n.type==Blockly.NEXT_STATEMENT?(g=!0,e=Math.max(e,m.titleWidth)):(n.type==Blockly.INPUT_VALUE?
f=!0:n.type==Blockly.DUMMY_INPUT&&(h=!0),d=Math.max(d,m.titleWidth)))}for(a=0;n=c[a];a++)if(n.thicker=!1,this.block_.inputsInline&&n.type==Blockly.BlockSvg.INLINE)for(b=0;m=n[b];b++)if(m.type==Blockly.INPUT_VALUE){n.height+=2*Blockly.BlockSvg.INLINE_PADDING_Y;n.thicker=!0;break}c.statementEdge=2*Blockly.BlockSvg.SEP_SPACE_X+e;g&&(c.rightEdge=Math.max(c.rightEdge,c.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH));f?c.rightEdge=Math.max(c.rightEdge,d+2*Blockly.BlockSvg.SEP_SPACE_X+Blockly.BlockSvg.TAB_WIDTH):
...
15),b.push("H",Blockly.BlockSvg.NOTCH_WIDTH-15),a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT),b.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT),this.block_.previousConnection.moveTo(c.x+(Blockly.RTL?-Blockly.BlockSvg.NOTCH_WIDTH:Blockly.BlockSvg.NOTCH_WIDTH),c.y));a.push("H",d);b.push("H",d+(Blockly.RTL?-1:0))};
Blockly.BlockSvg.prototype.renderDrawRight_=function(a,b,c,d,e,f,g){for(var h,k=0,l,m,n=0,q;q=f[n];n++){h=Blockly.BlockSvg.SEP_SPACE_X;0==n&&(h+=Blockly.RTL?-g:g);b.push("M",f.rightEdge-1+","+(k+1));if(q.type==Blockly.BlockSvg.INLINE){for(var r=0,p;p=q[r];r++)l=k+Blockly.BlockSvg.TITLE_HEIGHT,q.thicker&&(l+=Blockly.BlockSvg.INLINE_PADDING_Y),h=this.renderTitles_(p.titleRow,h,l),p.type!=Blockly.DUMMY_INPUT&&(h+=p.renderWidth+Blockly.BlockSvg.SEP_SPACE_X),p.type==Blockly.INPUT_VALUE&&(c.push("M",h-
...
p.renderWidth-1:e.x+h+Blockly.BlockSvg.TAB_WIDTH-Blockly.BlockSvg.SEP_SPACE_X-p.renderWidth+1,m=e.y+k+Blockly.BlockSvg.INLINE_PADDING_Y,p.connection.moveTo(l,m),p.connection.targetConnection&&p.connection.tighten_());h=Math.max(h,f.rightEdge);a.push("H",h);b.push("H",h+(Blockly.RTL?-1:0));a.push("v",q.height);Blockly.RTL&&b.push("v",q.height-2)}else q.type==Blockly.INPUT_VALUE?(p=q[0],l=k+Blockly.BlockSvg.TITLE_HEIGHT,p.align!=Blockly.ALIGN_LEFT&&(r=f.rightEdge-p.titleWidth-Blockly.BlockSvg.TAB_WIDTH-
2*Blockly.BlockSvg.SEP_SPACE_X,p.align==Blockly.ALIGN_RIGHT?h+=r:p.align==Blockly.ALIGN_CENTRE&&(h+=(r+h)/2)),this.renderTitles_(p.titleRow,h,l),a.push(Blockly.BlockSvg.TAB_PATH_DOWN),a.push("v",q.height-Blockly.BlockSvg.TAB_HEIGHT),Blockly.RTL?(b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),b.push("v",q.height-Blockly.BlockSvg.TAB_HEIGHT)):(b.push("M",f.rightEdge-4.2+","+(k+Blockly.BlockSvg.TAB_HEIGHT-0.4)),b.push("l",0.42*Blockly.BlockSvg.TAB_WIDTH+",-1.8")),l=e.x+(Blockly.RTL?-f.rightEdge-
1:f.rightEdge+1),m=e.y+k,p.connection.moveTo(l,m),p.connection.targetConnection&&p.connection.tighten_()):q.type==Blockly.DUMMY_INPUT?(p=q[0],l=k+Blockly.BlockSvg.TITLE_HEIGHT,p.align!=Blockly.ALIGN_LEFT&&(r=f.rightEdge-p.titleWidth-2*Blockly.BlockSvg.SEP_SPACE_X,f.hasValue&&(r-=Blockly.BlockSvg.TAB_WIDTH),p.align==Blockly.ALIGN_RIGHT?h+=r:p.align==Blockly.ALIGN_CENTRE&&(h+=(r+h)/2)),this.renderTitles_(p.titleRow,h,l),a.push("v",q.height),Blockly.RTL&&b.push("v",q.height-2)):q.type==Blockly.NEXT_STATEMENT&&
(p=q[0],0==n&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),Blockly.RTL&&b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y),l=k+Blockly.BlockSvg.TITLE_HEIGHT,p.align!=Blockly.ALIGN_LEFT&&(r=f.statementEdge-p.titleWidth-2*Blockly.BlockSvg.SEP_SPACE_X,p.align==Blockly.ALIGN_RIGHT?h+=r:p.align==Blockly.ALIGN_CENTRE&&(h+=(r+h)/2)),this.renderTitles_(p.titleRow,h,l),h=f.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH,a.push("H",h),a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER),a.push("v",
q.height-2*Blockly.BlockSvg.CORNER_RADIUS),a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER),a.push("H",f.rightEdge),Blockly.RTL?(b.push("M",h-Blockly.BlockSvg.NOTCH_WIDTH+Blockly.BlockSvg.DISTANCE_45_OUTSIDE+","+(k+Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),b.push("v",q.height-2*Blockly.BlockSvg.CORNER_RADIUS),b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL),b.push("H",f.rightEdge-1)):(b.push("M",h-Blockly.BlockSvg.NOTCH_WIDTH+
Blockly.BlockSvg.DISTANCE_45_OUTSIDE+","+(k+q.height-Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR),b.push("H",f.rightEdge)),l=e.x+(Blockly.RTL?-h:h),m=e.y+k+1,p.connection.moveTo(l,m),p.connection.targetConnection&&p.connection.tighten_(),n==f.length-1||f[n+1].type==Blockly.NEXT_STATEMENT)&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),Blockly.RTL&&b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y);k+=q.height}f.length||
(this.block_.collapsed&&(a.push(Blockly.BlockSvg.JAGGED_TEETH),Blockly.RTL?b.push("l 8,0 0,3.8 7,3.2 m -14.5,9 l 8,4"):b.push("h 8")),k=Blockly.BlockSvg.MIN_BLOCK_Y,a.push("V",k),Blockly.RTL&&b.push("V",k-1));return k};
...
this.iconMark_.appendChild(document.createTextNode("?"));this.block_.getSvgRoot().appendChild(this.iconGroup_);this.block_.editable&&!this.block_.isInFlyout&&Blockly.bindEvent_(this.iconGroup_,"mouseup",this,this.iconClick_)};
...
Blockly.ScrollbarPair.prototype.resize=function(){var a=this.getMetrics_();if(a){var b=!1,c=!1;this.oldHostMetrics_&&this.oldHostMetrics_.viewWidth==a.viewWidth&&this.oldHostMetrics_.viewHeight==a.viewHeight&&this.oldHostMetrics_.absoluteTop==a.absoluteTop&&this.oldHostMetrics_.absoluteLeft==a.absoluteLeft?(this.oldHostMetrics_&&this.oldHostMetrics_.contentWidth==a.contentWidth&&this.oldHostMetrics_.viewLeft==a.viewLeft&&this.oldHostMetrics_.contentLeft==a.contentLeft||(b=!0),this.oldHostMetrics_&&
...
3));this.onMouseDownBarWrapper_=Blockly.bindEvent_(this.svgBackground_,"mousedown",this,this.onMouseDownBar_);this.onMouseDownKnobWrapper_=Blockly.bindEvent_(this.svgKnob_,"mousedown",this,this.onMouseDownKnob_)};
...
Blockly.Workspace.prototype.dispose=function(){this.svgGroup_&&(goog.dom.removeNode(this.svgGroup_),this.svgGroup_=null);this.svgBubbleCanvas_=this.svgBlockCanvas_=null;this.trashcan&&(this.trashcan.dispose(),this.trashcan=null)};Blockly.Workspace.prototype.addTrashcan=function(a){Blockly.hasTrashcan&&!Blockly.readOnly&&(this.trashcan=new Blockly.Trashcan(a),a=this.trashcan.createDom(),this.svgGroup_.insertBefore(a,this.svgBlockCanvas_),this.trashcan.init())};
...
Blockly.ContextMenu.callbackFactory=function(a,b){return function(){var c=Blockly.Xml.domToBlock_(a.workspace,b),d=a.getRelativeToSurfaceXY();d.x=Blockly.RTL?d.x-Blockly.SNAP_RADIUS:d.x+Blockly.SNAP_RADIUS;d.y+=2*Blockly.SNAP_RADIUS;c.moveBy(d.x,d.y);c.select()}};Blockly.Field=function(a){this.sourceBlock_=null;this.group_=Blockly.createSvgElement("g",{},null);this.borderRect_=Blockly.createSvgElement("rect",{rx:4,ry:4,x:-Blockly.BlockSvg.SEP_SPACE_X/2,y:-12,height:16},this.group_);this.textElement_=Blockly.createSvgElement("text",{"class":"blocklyText"},this.group_);this.CURSOR&&(this.sourceBlock_&&this.sourceBlock_.editable)&&(this.group_.style.cursor=this.CURSOR);this.size_={height:25,width:0};this.setText(a)};Blockly.Field.NBSP="\u00a0";
Blockly.Field.prototype.EDITABLE=!0;Blockly.Field.prototype.init=function(a){if(this.sourceBlock_)throw"Field has already been initialized once.";this.sourceBlock_=a;this.group_.setAttribute("class",this.sourceBlock_.editable?"blocklyEditableText":"blocklyNonEditableText");a.getSvgRoot().appendChild(this.group_);this.sourceBlock_.editable&&(this.mouseUpWrapper_=Blockly.bindEvent_(this.group_,"mouseup",this,this.onMouseUp_));this.setText(null)};
...
this.block_.getSvgRoot().appendChild(this.iconGroup_);this.block_.editable&&!this.block_.isInFlyout&&Blockly.bindEvent_(this.iconGroup_,"mouseup",this,this.iconClick_)};Blockly.Warning.prototype.textToDom_=function(a){var b=Blockly.createSvgElement("text",{"class":"blocklyText",y:Blockly.Bubble.BORDER_WIDTH},null);a=a.split("\n");for(var c=0;c<a.length;c++){var d=Blockly.createSvgElement("tspan",{dy:"1em",x:Blockly.Bubble.BORDER_WIDTH},b),e=document.createTextNode(a[c]);d.appendChild(e)}return b};
Blockly.Warning.prototype.isVisible=function(){return!!this.bubble_};
...
Blockly.Block=function(a,b){this.id=++Blockly.uidCounter_;this.previousConnection=this.nextConnection=this.outputConnection=null;this.inputList=[];this.disabled=this.collapsed=this.rendered=this.inputsInline=!1;this.deletable=!Blockly.readOnly;this.movable=!Blockly.readOnly;this.editable=!Blockly.readOnly;this.tooltip="";this.contextMenu=!0;this.parentBlock_=null;this.childBlocks_=[];this.workspace=a;this.isInFlyout=a.isFlyout;a.addTopBlock(this);if(b){this.type=b;var c=Blockly.Language[b];if(!c)throw'Error: "'+
b+'" is an unknown language block.';goog.mixin(this,c)}goog.isFunction(this.init)&&this.init();goog.isFunction(this.onchange)&&Blockly.bindEvent_(a.getCanvas(),"blocklyWorkspaceChange",this,this.onchange)};Blockly.Block.prototype.svg_=null;Blockly.Block.prototype.mutator=null;Blockly.Block.prototype.comment=null;Blockly.Block.prototype.warning=null;
...
!this.helpUrl():!this.helpUrl)};e.text=Blockly.MSG_HELP;e.callback=function(){c.showHelp_()};d.push(e);this.customContextMenu&&this.customContextMenu(d);Blockly.ContextMenu.show(a,b,d)}};
...
Blockly.Block.prototype.setCollapsed=function(a){if(this.collapsed!=a){for(var b=(this.collapsed=a)?"none":"block",c=[],d=0,e;e=this.inputList[d];d++){for(var f=0,g;g=e.titleRow[f];f++)(g.getRootElement?g.getRootElement():g).style.display=b;e.connection&&(a?e.connection.hideAll():c=c.concat(e.connection.unhideAll()),e=e.connection.targetBlock())&&(e.svg_.getRootElement().style.display=b,a&&(e.rendered=!1))}a&&(this.mutator&&this.mutator.setVisible(!1),this.comment&&this.comment.setVisible(!1),this.warning&&
...
Blockly.FieldColour.prototype.setValue=function(a){this.colour_=a;this.borderRect_.style.fill=a;this.sourceBlock_&&this.sourceBlock_.rendered&&this.sourceBlock_.workspace.fireChangeEvent()};Blockly.FieldColour.COLOURS=goog.ui.ColorPicker.SIMPLE_GRID_COLORS;Blockly.FieldColour.COLUMNS=7;
Blockly.FieldColour.prototype.showEditor_=function(){Blockly.FieldColour.isOpen_=!0;goog.dom.removeChildren(Blockly.widgetDiv);Blockly.widgetDiv.style.display="block";var a=new goog.ui.ColorPicker;a.setSize(Blockly.FieldColour.COLUMNS);a.setColors(Blockly.FieldColour.COLOURS);a.render(Blockly.widgetDiv);a.setSelectedColor(this.getValue());var b=Blockly.getAbsoluteXY_(this.borderRect_),c=this.borderRect_.getBBox();Blockly.RTL&&(b.x+=c.width);b.y+=c.height-1;Blockly.RTL&&(b.x-=Blockly.widgetDiv.offsetWidth);
Blockly.widgetDiv.style.left=b.x+"px";Blockly.widgetDiv.style.top=b.y+"px";var d=this;Blockly.FieldColour.changeEventKey_=goog.events.listen(a,goog.ui.ColorPicker.EventType.CHANGE,function(a){a=a.target.getSelectedColor()||"#000000";Blockly.FieldColour.hide();if(d.changeHandler_){var b=d.changeHandler_(a);void 0!==b&&(a=b)}null!==a&&d.setValue(a)})};
...
l=0;l<k.length;l++){var m=k[l][1],n=Blockly.ContextMenu.optionToDom(k[l][0]),q=n.firstChild,r=n.lastChild;c.appendChild(n);h||m!=this.value_||(h=Blockly.createSvgElement("text",{"class":"blocklyMenuText",y:15},null),n.insertBefore(h,r),h.appendChild(document.createTextNode("\u2713")));n.setAttribute("transform","translate(0, "+l*Blockly.ContextMenu.Y_HEIGHT+")");g.push(q);Blockly.bindEvent_(n,"mousedown",null,Blockly.noEvent);Blockly.bindEvent_(n,"mouseup",this,a(m));Blockly.bindEvent_(n,"mouseup",
null,Blockly.FieldDropdown.hide);f=Math.max(f,r.getComputedTextLength())}f+=2*Blockly.ContextMenu.X_PADDING;for(l=0;l<g.length;l++)g[l].setAttribute("width",f);if(Blockly.RTL)for(l=0;n=c.childNodes[l];l++)r=n.lastChild,r.setAttribute("text-anchor","end"),r.setAttribute("x",f-Blockly.ContextMenu.X_PADDING);h&&(Blockly.RTL?(h.setAttribute("text-anchor","end"),h.setAttribute("x",f-5)):h.setAttribute("x",5));l=f+2*Blockly.FieldDropdown.CORNER_RADIUS;k=k.length*Blockly.ContextMenu.Y_HEIGHT+Blockly.FieldDropdown.CORNER_RADIUS+
1;e.setAttribute("width",l);e.setAttribute("height",k);d.setAttribute("width",l);d.setAttribute("height",k);e=Blockly.makeColour(this.sourceBlock_.getColour());d.setAttribute("fill",e);d=Blockly.getSvgXY_(this.borderRect_);e=this.borderRect_.getBBox();l=Blockly.RTL?d.x-f+Blockly.ContextMenu.X_PADDING+e.width-Blockly.BlockSvg.SEP_SPACE_X/2:d.x-Blockly.ContextMenu.X_PADDING+Blockly.BlockSvg.SEP_SPACE_X/2;b.setAttribute("transform","translate("+l+", "+(d.y+e.height)+")")};
...
Blockly.loadAudio_(["media/click.mp3","media/click.wav","media/click.ogg"],"click");Blockly.loadAudio_(["media/delete.mp3","media/delete.ogg","media/delete.wav"],"delete")};Blockly.utils={};Blockly.addClass_=function(a,b){var c=a.getAttribute("class")||"";-1==(" "+c+" ").indexOf(" "+b+" ")&&(c&&(c+=" "),a.setAttribute("class",c+b))};Blockly.removeClass_=function(a,b){var c=a.getAttribute("class");if(-1!=(" "+c+" ").indexOf(" "+b+" ")){for(var c=c.split(/\s+/),d=0;d<c.length;d++)c[d]&&c[d]!=b||(c.splice(d,1),d--);c.length?a.setAttribute("class",c.join(" ")):a.removeAttribute("class")}};
...
Blockly.convertCoordinates=function(a,b,c){var d=Blockly.svg.createSVGPoint();d.x=a;d.y=b;a=Blockly.svg.getScreenCTM();c&&(a=a.inverse());return d.matrixTransform(a)};Blockly.shortestStringLength=function(a){if(!a.length)return 0;for(var b=a[0].length,c=1;c<a.length;c++)b=Math.min(b,a[c].length);return b};
...
Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE]=Blockly.OUTPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE]=Blockly.INPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT]=Blockly.PREVIOUS_STATEMENT;Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT]=Blockly.NEXT_STATEMENT;Blockly.SOUNDS_={};Blockly.selected=null;Blockly.readOnly=!1;Blockly.highlightedConnection_=null;Blockly.localConnection_=null;Blockly.DRAG_RADIUS=5;Blockly.SNAP_RADIUS=15;Blockly.BUMP_DELAY=250;Blockly.mainWorkspace=null;
...
Blockly.svgResize=function(){var a=Blockly.svg,b=a.parentNode,c=b.offsetWidth,d=b.offsetHeight;a.cachedWidth_!=c&&(a.setAttribute("width",c+"px"),a.cachedWidth_=c);a.cachedHeight_!=d&&(a.setAttribute("height",d+"px"),a.cachedHeight_=d);a.cachedLeft_=0;for(a.cachedTop_=0;b;)a.cachedLeft_+=b.offsetLeft,a.cachedTop_+=b.offsetTop,b=b.offsetParent;Blockly.mainWorkspace.scrollbar&&Blockly.mainWorkspace.scrollbar.resize()};
Blockly.onMouseDown_=function(a){Blockly.Block.terminateDrag_();Blockly.hideChaff();var b=a.target&&a.target.nodeName&&"svg"==a.target.nodeName.toLowerCase();!Blockly.readOnly&&(Blockly.selected&&b)&&Blockly.selected.unselect();Blockly.isRightButton(a)?Blockly.ContextMenu&&Blockly.showContextMenu_(a.clientX,a.clientY):(Blockly.readOnly||b)&&Blockly.mainWorkspace.scrollbar&&(Blockly.mainWorkspace.dragMode=!0,Blockly.mainWorkspace.startDragMouseX=a.clientX,Blockly.mainWorkspace.startDragMouseY=a.clientY,
Blockly.mainWorkspace.startDragMetrics=Blockly.getMainWorkspaceMetrics(),Blockly.mainWorkspace.startScrollX=Blockly.mainWorkspace.scrollX,Blockly.mainWorkspace.startScrollY=Blockly.mainWorkspace.scrollY)};Blockly.onMouseUp_=function(a){Blockly.setCursorHand_(!1);Blockly.mainWorkspace.dragMode=!1};
...
Blockly.showContextMenu_=function(a,b){if(!Blockly.readOnly){var c=[];if(Blockly.collapse){for(var d=!1,e=!1,f=Blockly.mainWorkspace.getTopBlocks(!1),g=0;g<f.length;g++)f[g].collapsed?d=!0:e=!0;e={enabled:e};e.text=Blockly.MSG_COLLAPSE_ALL;e.callback=function(){for(var a=0;a<f.length;a++)f[a].setCollapsed(!0)};c.push(e);d={enabled:d};d.text=Blockly.MSG_EXPAND_ALL;d.callback=function(){for(var a=0;a<f.length;a++)f[a].setCollapsed(!1)};c.push(d)}d={enabled:!1};d.text=Blockly.MSG_HELP;d.callback=function(){};
c.push(d);Blockly.ContextMenu.show(a,b,c)}};Blockly.onContextMenu_=function(a){!Blockly.isTargetInput_(a)&&Blockly.ContextMenu&&a.preventDefault()};Blockly.hideChaff=function(a){Blockly.Tooltip&&Blockly.Tooltip.hide();Blockly.ContextMenu&&Blockly.ContextMenu.hide();Blockly.FieldDropdown&&Blockly.FieldDropdown.hide();Blockly.FieldColour&&Blockly.FieldColour.hide();!a&&(Blockly.Toolbox.flyout_&&Blockly.Toolbox.flyout_.autoClose)&&Blockly.Toolbox.clearSelection()};
...
Blockly.loadAudio_=function(a,b){if(window.Audio&&a.length){for(var c,d=new window.Audio,e=0;e<a.length;e++){var f=a[e],g=f.match(/\.(\w+)$/);if(g&&d.canPlayType("audio/"+g[1])){c=new window.Audio(Blockly.pathToBlockly+f);break}}c&&c.play&&(c.play(),c.volume=0.01,Blockly.SOUNDS_[b]=c)}};Blockly.playAudio=function(a,b){var c=Blockly.SOUNDS_[a];c&&(c=goog.userAgent.DOCUMENT_MODE&&9===goog.userAgent.DOCUMENT_MODE||goog.userAgent.IPAD||goog.userAgent.ANDROID?c:c.cloneNode(),c.volume=void 0===b?1:b,c.play())};
Blockly.setCursorHand_=function(a){if(!Blockly.readOnly){var b="";a&&(b="url("+Blockly.pathToBlockly+"media/handclosed.cur) 7 3, auto");Blockly.selected&&(Blockly.selected.getSvgRoot().style.cursor=b);document.getElementsByTagName("svg")[0].style.cursor=b}};
Blockly.getMainWorkspaceMetrics=function(){var a=Blockly.svgSize();a.width-=Blockly.Toolbox.width;var b=a.width-Blockly.Scrollbar.scrollbarThickness,c=a.height-Blockly.Scrollbar.scrollbarThickness;try{var d=Blockly.mainWorkspace.getCanvas().getBBox()}catch(e){return null}var f=Math.min(d.x-b/2,d.x+d.width-b),b=Math.max(d.x+d.width+b/2,d.x+b),g=Math.min(d.y-c/2,d.y+d.height-c),c=Math.max(d.y+d.height+c/2,d.y+c);return{viewHeight:a.height,viewWidth:a.width,contentHeight:c-g,contentWidth:b-f,viewTop:-Blockly.mainWorkspace.scrollY,
viewLeft:-Blockly.mainWorkspace.scrollX,contentTop:g,contentLeft:f,absoluteTop:0,absoluteLeft:Blockly.RTL?0:Blockly.Toolbox.width}};
...
Blockly.addChangeListener=function(a){return Blockly.bindEvent_(Blockly.mainWorkspace.getCanvas(),"blocklyWorkspaceChange",null,a)};Blockly.removeChangeListener=function(a){Blockly.unbindEvent_(a)};// Do not edit this file; automatically generated by build.py.
"use strict";
...
b+e};Blockly.JavaScript.procedures={};
...
Blockly.JavaScript.logic_ternary=function(){var a=Blockly.JavaScript.valueToCode(this,"IF",Blockly.JavaScript.ORDER_CONDITIONAL)||"false",b=Blockly.JavaScript.valueToCode(this,"THEN",Blockly.JavaScript.ORDER_CONDITIONAL)||"null",c=Blockly.JavaScript.valueToCode(this,"ELSE",Blockly.JavaScript.ORDER_CONDITIONAL)||"null";return[a+" ? "+b+" : "+c,Blockly.JavaScript.ORDER_CONDITIONAL]};Blockly.JavaScript.control={};Blockly.JavaScript.controls_repeat=function(){var a=Number(this.getTitleValue("TIMES")),b=Blockly.JavaScript.statementToCode(this,"DO");Blockly.JavaScript.INFINITE_LOOP_TRAP&&(b=Blockly.JavaScript.INFINITE_LOOP_TRAP.replace(/%1/g,"'"+this.id+"'")+b);var c=Blockly.JavaScript.variableDB_.getDistinctName("count",Blockly.Variables.NAME_TYPE);return"for (var "+c+" = 0; "+c+" < "+a+"; "+c+"++) {\n"+b+"}\n"};
...
"_end",Blockly.Variables.NAME_TYPE),g+="var "+b+" = "+c+";\n"),c=Blockly.JavaScript.variableDB_.getDistinctName(a+"_inc",Blockly.Variables.NAME_TYPE),g+="var "+c+" = ",g=Blockly.isNumber(d)?g+(Math.abs(d)+";\n"):g+("Math.abs("+d+");\n"),g+="if ("+f+" > "+b+") {\n",g+="  "+c+" = -"+c+";\n",g+="}\n",g+="for ("+a+" = "+f+";\n     "+c+" >= 0 ? "+a+" <= "+b+" : "+a+" >= "+b+";\n     "+a+" += "+c+") {\n"+e+"}\n";return g};
...
Blockly.LANG_COLOUR_BLEND_HELPURL="http://meyerweb.com/eric/tools/color-blend/";Blockly.LANG_COLOUR_BLEND_TITLE="blend";Blockly.LANG_COLOUR_BLEND_COLOUR1="colour 1";Blockly.LANG_COLOUR_BLEND_COLOUR2="colour 2";Blockly.LANG_COLOUR_BLEND_RATIO="ratio";Blockly.LANG_COLOUR_BLEND_TOOLTIP="Blends two colours together with a given ratio (0.0 - 1.0).";Blockly.LANG_CONTROLS_REPEAT_HELPURL="http://en.wikipedia.org/wiki/For_loop";Blockly.LANG_CONTROLS_REPEAT_TITLE_REPEAT="repeat";
Blockly.LANG_CONTROLS_REPEAT_TITLE_TIMES="times";Blockly.LANG_CONTROLS_REPEAT_INPUT_DO="do";Blockly.LANG_CONTROLS_REPEAT_TOOLTIP="Do some statements several times.";Blockly.LANG_CONTROLS_WHILEUNTIL_HELPURL="http://code.google.com/p/blockly/wiki/Repeat";Blockly.LANG_CONTROLS_WHILEUNTIL_INPUT_DO="do";Blockly.LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE="repeat while";Blockly.LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL="repeat until";Blockly.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE="While a value is true, then do some statements.";
Blockly.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL="While a value is false, then do some statements.";Blockly.LANG_CONTROLS_FOR_HELPURL="http://en.wikipedia.org/wiki/For_loop";Blockly.LANG_CONTROLS_FOR_INPUT_WITH="count with";Blockly.LANG_CONTROLS_FOR_INPUT_VAR="x";Blockly.LANG_CONTROLS_FOR_INPUT_FROM="from";Blockly.LANG_CONTROLS_FOR_INPUT_TO="to";Blockly.LANG_CONTROLS_FOR_INPUT_BY="by";Blockly.LANG_CONTROLS_FOR_INPUT_DO="do";Blockly.LANG_CONTROLS_FOR_TAIL="";Blockly.LANG_CONTROLS_FOR_TOOLTIP='Count from a start number to an end number by the specified interval.\nFor each count, set the current count number to\nvariable "%1", and then do some statements.';
...
Blockly.LANG_CONTROLS_IF_HELPURL="http://code.google.com/p/blockly/wiki/If_Then";Blockly.LANG_CONTROLS_IF_TOOLTIP_1="If a value is true, then do some statements.";Blockly.LANG_CONTROLS_IF_TOOLTIP_2="If a value is true, then do the first block of statements.\nOtherwise, do the second block of statements.";Blockly.LANG_CONTROLS_IF_TOOLTIP_3="If the first value is true, then do the first block of statements.\nOtherwise, if the second value is true, do the second block of statements.";
...
Blockly.LANG_CONTROLS_IF_ELSEIF_TITLE_ELSEIF="else if";Blockly.LANG_CONTROLS_IF_ELSEIF_TOOLTIP="Add a condition to the if block.";Blockly.LANG_CONTROLS_IF_ELSE_TITLE_ELSE="else";Blockly.LANG_CONTROLS_IF_ELSE_TOOLTIP="Add a final, catch-all condition to the if block.";Blockly.LANG_LOGIC_COMPARE_HELPURL="http://en.wikipedia.org/wiki/Inequality_(mathematics)";Blockly.LANG_LOGIC_COMPARE_TOOLTIP_EQ="Return true if both inputs equal each other.";Blockly.LANG_LOGIC_COMPARE_TOOLTIP_NEQ="Return true if both inputs are not equal to each other.";
Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LT="Return true if the first input is smaller\nthan the second input.";Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LTE="Return true if the first input is smaller\nthan or equal to the second input.";Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GT="Return true if the first input is greater\nthan the second input.";Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GTE="Return true if the first input is greater\nthan or equal to the second input.";Blockly.LANG_LOGIC_OPERATION_HELPURL="http://code.google.com/p/blockly/wiki/And_Or";
Blockly.LANG_LOGIC_OPERATION_AND="and";Blockly.LANG_LOGIC_OPERATION_OR="or";Blockly.LANG_LOGIC_OPERATION_TOOLTIP_AND="Return true if both inputs are true.";Blockly.LANG_LOGIC_OPERATION_TOOLTIP_OR="Return true if either inputs are true.";Blockly.LANG_LOGIC_NEGATE_HELPURL="http://code.google.com/p/blockly/wiki/Not";Blockly.LANG_LOGIC_NEGATE_INPUT_NOT="not";Blockly.LANG_LOGIC_NEGATE_TOOLTIP="Returns true if the input is false.\nReturns false if the input is true.";
Blockly.LANG_LOGIC_BOOLEAN_HELPURL="http://code.google.com/p/blockly/wiki/True_False";Blockly.LANG_LOGIC_BOOLEAN_TRUE="true";Blockly.LANG_LOGIC_BOOLEAN_FALSE="false";Blockly.LANG_LOGIC_BOOLEAN_TOOLTIP="Returns either true or false.";Blockly.LANG_LOGIC_NULL_HELPURL="http://en.wikipedia.org/wiki/Nullable_type";Blockly.LANG_LOGIC_NULL="null";Blockly.LANG_LOGIC_NULL_TOOLTIP="Returns null.";Blockly.LANG_LOGIC_TERNARY_HELPURL="http://en.wikipedia.org/wiki/%3F:";Blockly.LANG_LOGIC_TERNARY_CONDITION="test";
Blockly.LANG_LOGIC_TERNARY_IF_TRUE="if true";Blockly.LANG_LOGIC_TERNARY_IF_FALSE="if false";Blockly.LANG_LOGIC_TERNARY_TOOLTIP='Check the condition in "test". If the condition is true\nreturns the "if true" value, otherwise returns the "if false" value.';Blockly.LANG_MATH_NUMBER_HELPURL="http://en.wikipedia.org/wiki/Number";Blockly.LANG_MATH_NUMBER_TOOLTIP="A number.";Blockly.LANG_MATH_ARITHMETIC_HELPURL="http://en.wikipedia.org/wiki/Arithmetic";Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_ADD="Return the sum of the two numbers.";
Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_MINUS="Return the difference of the two numbers.";Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_MULTIPLY="Return the product of the two numbers.";Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_DIVIDE="Return the quotient of the two numbers.";Blockly.LANG_MATH_ARITHMETIC_TOOLTIP_POWER="Return the first number raised to\nthe power of the second number.";Blockly.LANG_MATH_SINGLE_HELPURL="http://en.wikipedia.org/wiki/Square_root";Blockly.LANG_MATH_SINGLE_OP_ROOT="square root";
Blockly.LANG_MATH_SINGLE_OP_ABSOLUTE="absolute";Blockly.LANG_MATH_SINGLE_TOOLTIP_ROOT="Return the square root of a number.";Blockly.LANG_MATH_SINGLE_TOOLTIP_ABS="Return the absolute value of a number.";Blockly.LANG_MATH_SINGLE_TOOLTIP_NEG="Return the negation of a number.";Blockly.LANG_MATH_SINGLE_TOOLTIP_LN="Return the natural logarithm of a number.";Blockly.LANG_MATH_SINGLE_TOOLTIP_LOG10="Return the base 10 logarithm of a number.";Blockly.LANG_MATH_SINGLE_TOOLTIP_EXP="Return e to the power of a number.";
Blockly.LANG_MATH_SINGLE_TOOLTIP_POW10="Return 10 to the power of a number.";Blockly.LANG_MATH_TRIG_HELPURL="http://en.wikipedia.org/wiki/Trigonometric_functions";Blockly.LANG_MATH_TRIG_TOOLTIP_SIN="Return the sine of a degree (not radian).";Blockly.LANG_MATH_TRIG_TOOLTIP_COS="Return the cosine of a degree (not radian).";Blockly.LANG_MATH_TRIG_TOOLTIP_TAN="Return the tangent of a degree (not radian).";Blockly.LANG_MATH_TRIG_TOOLTIP_ASIN="Return the arcsine of a number.";
Blockly.LANG_MATH_TRIG_TOOLTIP_ACOS="Return the arccosine of a number.";Blockly.LANG_MATH_TRIG_TOOLTIP_ATAN="Return the arctangent of a number.";Blockly.LANG_MATH_CONSTANT_HELPURL="http://en.wikipedia.org/wiki/Mathematical_constant";Blockly.LANG_MATH_CONSTANT_TOOLTIP="Return one of the common constants: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026),\nsqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026), or \u221e (infinity).";Blockly.LANG_MATH_IS_EVEN="is even";
Blockly.LANG_MATH_IS_ODD="is odd";Blockly.LANG_MATH_IS_PRIME="is prime";Blockly.LANG_MATH_IS_WHOLE="is whole";Blockly.LANG_MATH_IS_POSITIVE="is positive";Blockly.LANG_MATH_IS_NEGATIVE="is negative";Blockly.LANG_MATH_IS_DIVISIBLE_BY="is divisible by";Blockly.LANG_MATH_IS_TOOLTIP="Check if a number is an even, odd, prime, whole, positive, negative,\nor if it is divisible by certain number.  Returns true or false.";Blockly.LANG_MATH_CHANGE_HELPURL="http://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter";
Blockly.LANG_MATH_CHANGE_TITLE_CHANGE="change";Blockly.LANG_MATH_CHANGE_TITLE_ITEM="item";Blockly.LANG_MATH_CHANGE_INPUT_BY="by";Blockly.LANG_MATH_CHANGE_TOOLTIP='Add a number to variable "%1".';Blockly.LANG_MATH_ROUND_HELPURL="http://en.wikipedia.org/wiki/Rounding";Blockly.LANG_MATH_ROUND_TOOLTIP="Round a number up or down.";Blockly.LANG_MATH_ROUND_OPERATOR_ROUND="round";Blockly.LANG_MATH_ROUND_OPERATOR_ROUNDUP="round up";Blockly.LANG_MATH_ROUND_OPERATOR_ROUNDDOWN="round down";
Blockly.LANG_MATH_ONLIST_HELPURL="";Blockly.LANG_MATH_ONLIST_OPERATOR_SUM="sum of list";Blockly.LANG_MATH_ONLIST_OPERATOR_MIN="min of list";Blockly.LANG_MATH_ONLIST_OPERATOR_MAX="max of list";Blockly.LANG_MATH_ONLIST_OPERATOR_AVERAGE="average of list";Blockly.LANG_MATH_ONLIST_OPERATOR_MEDIAN="median of list";Blockly.LANG_MATH_ONLIST_OPERATOR_MODE="modes of list";Blockly.LANG_MATH_ONLIST_OPERATOR_STD_DEV="standard deviation of list";Blockly.LANG_MATH_ONLIST_OPERATOR_RANDOM="random item of list";
Blockly.LANG_MATH_ONLIST_TOOLTIP_SUM="Return the sum of all the numbers in the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_MIN="Return the smallest number in the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_MAX="Return the largest number in the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_AVERAGE="Return the arithmetic mean of the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_MEDIAN="Return the median number in the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_MODE="Return a list of the most common item(s) in the list.";
Blockly.LANG_MATH_ONLIST_TOOLTIP_STD_DEV="Return the standard deviation of the list.";Blockly.LANG_MATH_ONLIST_TOOLTIP_RANDOM="Return a random element from the list.";Blockly.LANG_MATH_MODULO_HELPURL="http://en.wikipedia.org/wiki/Modulo_operation";Blockly.LANG_MATH_MODULO_INPUT_DIVIDEND="remainder of";Blockly.LANG_MATH_MODULO_TOOLTIP="Return the remainder from dividing the two numbers.";Blockly.LANG_MATH_CONSTRAIN_HELPURL="http://en.wikipedia.org/wiki/Clamping_%28graphics%29";
Blockly.LANG_MATH_CONSTRAIN_INPUT_CONSTRAIN="constrain";Blockly.LANG_MATH_CONSTRAIN_INPUT_LOW="low";Blockly.LANG_MATH_CONSTRAIN_INPUT_HIGH="high";Blockly.LANG_MATH_CONSTRAIN_TOOLTIP="Constrain a number to be between the specified limits (inclusive).";Blockly.LANG_MATH_RANDOM_INT_HELPURL="http://en.wikipedia.org/wiki/Random_number_generation";Blockly.LANG_MATH_RANDOM_INT_INPUT_FROM="random integer from";Blockly.LANG_MATH_RANDOM_INT_INPUT_TO="to";Blockly.LANG_MATH_RANDOM_INT_TOOLTIP="Return a random integer between the two\nspecified limits, inclusive.";
Blockly.LANG_MATH_RANDOM_FLOAT_HELPURL="http://en.wikipedia.org/wiki/Random_number_generation";Blockly.LANG_MATH_RANDOM_FLOAT_TITLE_RANDOM="random fraction";Blockly.LANG_MATH_RANDOM_FLOAT_TOOLTIP="Return a random fraction between\n0.0 (inclusive) and 1.0 (exclusive).";Blockly.LANG_TEXT_TEXT_HELPURL="http://en.wikipedia.org/wiki/String_(computer_science)";Blockly.LANG_TEXT_TEXT_TOOLTIP="A letter, word, or line of text.";Blockly.LANG_TEXT_JOIN_HELPURL="";Blockly.LANG_TEXT_JOIN_TITLE_CREATEWITH="create text with";
...
Blockly.LANG_TEXT_APPEND_TO="to";Blockly.LANG_TEXT_APPEND_APPENDTEXT="append text";Blockly.LANG_TEXT_APPEND_VARIABLE="item";Blockly.LANG_TEXT_APPEND_TOOLTIP='Append some text to variable "%1".';Blockly.LANG_TEXT_LENGTH_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_TEXT_LENGTH_INPUT_LENGTH="length of";Blockly.LANG_TEXT_LENGTH_TOOLTIP="Returns number of letters (including spaces)\nin the provided text.";Blockly.LANG_TEXT_ISEMPTY_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";
Blockly.LANG_TEXT_ISEMPTY_INPUT_ISEMPTY="is empty";Blockly.LANG_TEXT_ISEMPTY_TOOLTIP="Returns true if the provided text is empty.";Blockly.LANG_TEXT_INDEXOF_HELPURL="http://publib.boulder.ibm.com/infocenter/lnxpcomp/v8v101/index.jsp?topic=%2Fcom.ibm.xlcpp8l.doc%2Flanguage%2Fref%2Farsubex.htm";Blockly.LANG_TEXT_INDEXOF_INPUT_INTEXT="in text";Blockly.LANG_TEXT_INDEXOF_OPERATOR_FIRST="find first occurrence of text";Blockly.LANG_TEXT_INDEXOF_OPERATOR_LAST="find last occurrence of text";
Blockly.LANG_TEXT_INDEXOF_TOOLTIP="Returns the index of the first/last occurrence\nof first text in the second text.\nReturns 0 if text is not found.";Blockly.LANG_TEXT_CHARAT_HELPURL="http://publib.boulder.ibm.com/infocenter/lnxpcomp/v8v101/index.jsp?topic=%2Fcom.ibm.xlcpp8l.doc%2Flanguage%2Fref%2Farsubex.htm";Blockly.LANG_TEXT_CHARAT_INPUT_INTEXT="in text";Blockly.LANG_TEXT_CHARAT_FROM_START="get letter #";Blockly.LANG_TEXT_CHARAT_FROM_END="get letter # from end";
Blockly.LANG_TEXT_CHARAT_FIRST="get first letter";Blockly.LANG_TEXT_CHARAT_LAST="get last letter";Blockly.LANG_TEXT_CHARAT_RANDOM="get random letter";Blockly.LANG_TEXT_CHARAT_TOOLTIP="Returns the letter at the specified position.";Blockly.LANG_TEXT_SUBSTRING_HELPURL="http://publib.boulder.ibm.com/infocenter/lnxpcomp/v8v101/index.jsp?topic=%2Fcom.ibm.xlcpp8l.doc%2Flanguage%2Fref%2Farsubex.htm";Blockly.LANG_TEXT_SUBSTRING_INPUT_IN_TEXT="in text";Blockly.LANG_TEXT_SUBSTRING_INPUT_AT1="get substring from";
Blockly.LANG_TEXT_SUBSTRING_INPUT_AT2="to";Blockly.LANG_TEXT_SUBSTRING_FROM_START="letter #";Blockly.LANG_TEXT_SUBSTRING_FROM_END="letter # from end";Blockly.LANG_TEXT_SUBSTRING_FIRST="first letter";Blockly.LANG_TEXT_SUBSTRING_LAST="last letter";Blockly.LANG_TEXT_SUBSTRING_TOOLTIP="Returns a specified portion of the text.";Blockly.LANG_TEXT_CHANGECASE_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_TEXT_CHANGECASE_OPERATOR_UPPERCASE="to UPPER CASE";
Blockly.LANG_TEXT_CHANGECASE_OPERATOR_LOWERCASE="to lower case";Blockly.LANG_TEXT_CHANGECASE_OPERATOR_TITLECASE="to Title Case";Blockly.LANG_TEXT_CHANGECASE_TOOLTIP="Return a copy of the text in a different case.";Blockly.LANG_TEXT_TRIM_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_TEXT_TRIM_OPERATOR_BOTH="trim spaces from both sides";Blockly.LANG_TEXT_TRIM_OPERATOR_LEFT="trim spaces from left side";Blockly.LANG_TEXT_TRIM_OPERATOR_RIGHT="trim spaces from right side";
Blockly.LANG_TEXT_TRIM_TOOLTIP="Return a copy of the text with spaces\nremoved from one or both ends.";Blockly.LANG_TEXT_PRINT_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_TEXT_PRINT_TITLE_PRINT="print";Blockly.LANG_TEXT_PRINT_TOOLTIP="Print the specified text, number or other value.";Blockly.LANG_TEXT_PROMPT_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode92.html";Blockly.LANG_TEXT_PROMPT_TYPE_TEXT="prompt for text with message";
Blockly.LANG_TEXT_PROMPT_TYPE_NUMBER="prompt for number with message";Blockly.LANG_TEXT_PROMPT_TOOLTIP_NUMBER="Prompt for user for a number.";Blockly.LANG_TEXT_PROMPT_TOOLTIP_TEXT="Prompt for user for some text.";Blockly.LANG_LISTS_CREATE_EMPTY_HELPURL="http://en.wikipedia.org/wiki/Linked_list#Empty_lists";Blockly.LANG_LISTS_CREATE_EMPTY_TITLE="create empty list";Blockly.LANG_LISTS_CREATE_EMPTY_TOOLTIP="Returns a list, of length 0, containing no data records";
...
Blockly.LANG_LISTS_REPEAT_INPUT_WITH="create list with item";Blockly.LANG_LISTS_REPEAT_INPUT_REPEATED="repeated";Blockly.LANG_LISTS_REPEAT_INPUT_TIMES="times";Blockly.LANG_LISTS_REPEAT_TOOLTIP="Creates a list consisting of the given value\nrepeated the specified number of times.";Blockly.LANG_LISTS_LENGTH_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_LISTS_LENGTH_INPUT_LENGTH="length of";Blockly.LANG_LISTS_LENGTH_TOOLTIP="Returns the length of a list.";
Blockly.LANG_LISTS_IS_EMPTY_HELPURL="http://www.liv.ac.uk/HPC/HTMLF90Course/HTMLF90CourseNotesnode91.html";Blockly.LANG_LISTS_INPUT_IS_EMPTY="is empty";Blockly.LANG_LISTS_TOOLTIP="Returns true if the list is empty.";Blockly.LANG_LISTS_INDEX_OF_HELPURL="http://publib.boulder.ibm.com/infocenter/lnxpcomp/v8v101/index.jsp?topic=%2Fcom.ibm.xlcpp8l.doc%2Flanguage%2Fref%2Farsubex.htm";Blockly.LANG_LISTS_INDEX_OF_INPUT_IN_LIST="in list";Blockly.LANG_LISTS_INDEX_OF_FIRST="find first occurrence of item";
Blockly.LANG_LISTS_INDEX_OF_LAST="find last occurrence of item";Blockly.LANG_LISTS_INDEX_OF_TOOLTIP="Returns the index of the first/last occurrence\nof the item in the list.\nReturns 0 if text is not found.";Blockly.LANG_LISTS_GET_INDEX_HELPURL="http://publib.boulder.ibm.com/infocenter/lnxpcomp/v8v101/index.jsp?topic=%2Fcom.ibm.xlcpp8l.doc%2Flanguage%2Fref%2Farsubex.htm";Blockly.LANG_LISTS_GET_INDEX_GET="get";Blockly.LANG_LISTS_GET_INDEX_GET_REMOVE="get and remove";
...
Blockly.LANG_LISTS_GET_SUBLIST_INPUT_IN_LIST="in list";Blockly.LANG_LISTS_GET_SUBLIST_INPUT_AT1="get sub-list from";Blockly.LANG_LISTS_GET_SUBLIST_INPUT_AT2="to";Blockly.LANG_LISTS_GET_SUBLIST_TOOLTIP="Creates a copy of the specified portion of a list.";Blockly.LANG_VARIABLES_GET_HELPURL="http://en.wikipedia.org/wiki/Variable_(computer_science)";Blockly.LANG_VARIABLES_GET_TITLE=null;Blockly.LANG_VARIABLES_GET_ITEM="item";Blockly.LANG_VARIABLES_GET_TAIL=null;Blockly.LANG_VARIABLES_GET_TOOLTIP="Returns the value of this variable.";
Blockly.LANG_VARIABLES_GET_CREATE_SET='Create "set %1"';Blockly.LANG_VARIABLES_SET_HELPURL="http://en.wikipedia.org/wiki/Variable_(computer_science)";Blockly.LANG_VARIABLES_SET_TITLE="set";Blockly.LANG_VARIABLES_SET_ITEM="item";Blockly.LANG_VARIABLES_SET_TAIL="to";Blockly.LANG_VARIABLES_SET_TOOLTIP="Sets this variable to be equal to the input.";Blockly.LANG_VARIABLES_SET_CREATE_GET='Create "get %1"';Blockly.LANG_PROCEDURES_DEFNORETURN_HELPURL="http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.LANG_PROCEDURES_DEFNORETURN_TITLE="to";Blockly.LANG_PROCEDURES_DEFNORETURN_PROCEDURE="do something";Blockly.LANG_PROCEDURES_BEFORE_PARAMS="with:";Blockly.LANG_PROCEDURES_DEFNORETURN_DO="";Blockly.LANG_PROCEDURES_DEFNORETURN_TOOLTIP="Creates a function with no output.";Blockly.LANG_PROCEDURES_DEFRETURN_HELPURL="http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";Blockly.LANG_PROCEDURES_DEFRETURN_TITLE=Blockly.LANG_PROCEDURES_DEFNORETURN_TITLE;
Blockly.LANG_PROCEDURES_DEFRETURN_PROCEDURE=Blockly.LANG_PROCEDURES_DEFNORETURN_PROCEDURE;Blockly.LANG_PROCEDURES_DEFRETURN_DO=Blockly.LANG_PROCEDURES_DEFNORETURN_DO;Blockly.LANG_PROCEDURES_DEFRETURN_RETURN="return";Blockly.LANG_PROCEDURES_DEFRETURN_TOOLTIP="Creates a function with an output.";Blockly.LANG_PROCEDURES_DEF_DUPLICATE_WARNING="Warning:\nThis function has\nduplicate parameters.";Blockly.LANG_PROCEDURES_CALLNORETURN_HELPURL="http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.LANG_PROCEDURES_CALLNORETURN_CALL="";Blockly.LANG_PROCEDURES_CALLNORETURN_TOOLTIP='Run the user-defined function "%1".';Blockly.LANG_PROCEDURES_CALLRETURN_HELPURL="http://en.wikipedia.org/wiki/Procedure_%28computer_science%29";Blockly.LANG_PROCEDURES_CALLRETURN_CALL=Blockly.LANG_PROCEDURES_CALLNORETURN_CALL;Blockly.LANG_PROCEDURES_CALLRETURN_TOOLTIP='Run the user-defined function "%1" and use its output.';Blockly.LANG_PROCEDURES_MUTATORCONTAINER_TITLE="inputs";
Blockly.LANG_PROCEDURES_MUTATORARG_TITLE="input name:";Blockly.LANG_PROCEDURES_HIGHLIGHT_DEF="Highlight procedure definition";Blockly.LANG_PROCEDURES_CREATE_DO='Create "%1"';Blockly.LANG_PROCEDURES_IFRETURN_TOOLTIP="If a value is true, then return a value.";Blockly.LANG_PROCEDURES_IFRETURN_WARNING="Warning:\nThis block may only be\nused within a function definition.";Blockly.Language.PROCEDURE_TYPE_HUE=290;
Blockly.Language.procedures_defnoreturn={category:null,helpUrl:Blockly.LANG_PROCEDURES_DEFNORETURN_HELPURL,init:function(){this.setColour(Blockly.Language.PROCEDURE_TYPE_HUE);var a=Blockly.Procedures.findLegalName(Blockly.LANG_PROCEDURES_DEFNORETURN_PROCEDURE,this);this.appendDummyInput().appendTitle(Blockly.LANG_PROCEDURES_DEFNORETURN_TITLE).appendTitle(new Blockly.FieldTextInput(a,Blockly.Procedures.rename),"NAME").appendTitle("","PARAMS");this.appendStatementInput("STACK").appendTitle(Blockly.LANG_PROCEDURES_DEFNORETURN_DO);this.setMutator(new Blockly.Mutator(["procedures_mutatorarg"]));
this.setTooltip(Blockly.LANG_PROCEDURES_DEFNORETURN_TOOLTIP);this.arguments_=[]},updateParams_:function(){for(var a=!1,b={},c=0;c<this.arguments_.length;c++){if(b["arg_"+this.arguments_[c].toLowerCase()]){a=!0;break}b["arg_"+this.arguments_[c].toLowerCase()]=!0}a?this.setWarningText(Blockly.LANG_PROCEDURES_DEF_DUPLICATE_WARNING):this.setWarningText(null);a="";this.arguments_.length&&(a=Blockly.LANG_PROCEDURES_BEFORE_PARAMS+" "+this.arguments_.join(", "));this.setTitleValue(a,"PARAMS")},mutationToDom:function(){for(var a=
...
(this.arguments_[d]=b,c=!0);if(c&&(this.updateParams_(),this.mutator.isVisible_()))for(var c=this.mutator.workspace_.getAllBlocks(),d=0,e;e=c[d];d++)"procedures_mutatorarg"==e.type&&Blockly.Names.equals(a,e.getTitleValue("NAME"))&&e.setTitleValue(b,"NAME")},customContextMenu:function(a){var b={enabled:!0},c=this.getTitleValue("NAME");b.text=Blockly.LANG_PROCEDURES_CREATE_DO.replace("%1",c);var d=goog.dom.createDom("mutation");d.setAttribute("name",c);for(var e=0;e<this.arguments_.length;e++)c=goog.dom.createDom("arg"),
...
Blockly.Language.procedures_mutatorcontainer={init:function(){this.setColour(Blockly.Language.PROCEDURE_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_PROCEDURES_MUTATORCONTAINER_TITLE);this.appendStatementInput("STACK");this.setTooltip("");this.contextMenu=!1}};
...
Blockly.Language.procedures_callnoreturn={category:null,helpUrl:Blockly.LANG_PROCEDURES_CALLNORETURN_HELPURL,init:function(){this.setColour(Blockly.Language.PROCEDURE_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_PROCEDURES_CALLNORETURN_CALL).appendTitle("","NAME");this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.LANG_PROCEDURES_CALLNORETURN_TOOLTIP);this.arguments_=[];this.quarkArguments_=this.quarkConnections_=null},getProcedureCall:function(){return this.getTitleValue("NAME")},
renameProcedure:function(a,b){Blockly.Names.equals(a,this.getTitleValue("NAME"))&&(this.setTitleValue(b,"NAME"),this.setTooltip((this.outputConnection?Blockly.LANG_PROCEDURES_CALLRETURN_TOOLTIP:Blockly.LANG_PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1",b)))},setProcedureParameters:function(a,b){if(b){if(b.length!=a.length)throw"Error: paramNames and paramIds must be the same length.";this.quarkArguments_||(this.quarkConnections_={},a.join("\n")==this.arguments_.join("\n")?this.quarkArguments_=b:this.quarkArguments_=
[]);var c=this.rendered;this.rendered=!1;for(var d=this.arguments_.length-1;0<=d;d--){var e=this.getInput("ARG"+d);if(e){var f=e.connection.targetConnection;this.quarkConnections_[this.quarkArguments_[d]]=f;this.removeInput("ARG"+d)}}this.arguments_=[].concat(a);this.quarkArguments_=b;for(d=0;d<this.arguments_.length;d++)if(e=this.appendValueInput("ARG"+d).setAlign(Blockly.ALIGN_RIGHT).appendTitle(this.arguments_[d]),this.quarkArguments_){var g=this.quarkArguments_[d];g in this.quarkConnections_&&
...
domToMutation:function(a){var b=a.getAttribute("name");this.setTitleValue(b,"NAME");this.setTooltip((this.outputConnection?Blockly.LANG_PROCEDURES_CALLRETURN_TOOLTIP:Blockly.LANG_PROCEDURES_CALLNORETURN_TOOLTIP).replace("%1",b));if((b=Blockly.Procedures.getDefinition(b,this.workspace))&&b.mutator.isVisible())this.setProcedureParameters(b.arguments_,b.paramIds_);else{this.arguments_=[];for(var b=0,c;c=a.childNodes[b];b++)"arg"==c.nodeName.toLowerCase()&&this.arguments_.push(c.getAttribute("name"));
...
b=this.getInput("AT1").type==Blockly.INPUT_VALUE;a.setAttribute("at1",b);b=this.getInput("AT2").type==Blockly.INPUT_VALUE;a.setAttribute("at2",b);return a},domToMutation:function(a){var b="true"==a.getAttribute("at1");a="true"==a.getAttribute("at1");this.updateAt(1,b);this.updateAt(2,a)},updateAt:function(a,b){this.removeInput("AT"+a);b?this.appendValueInput("AT"+a).setCheck("Number"):this.appendDummyInput("AT"+a);var c=new Blockly.FieldDropdown(this["WHERE"+a],function(c){var e="FROM_START"==c||
"FROM_END"==c;if(e!=b){var f=this.sourceBlock_;f.updateAt(a,e);f.setTitleValue(c,"WHERE"+a);return null}});this.getInput("AT"+a).appendTitle(Blockly["LANG_TEXT_SUBSTRING_INPUT_AT"+a]).appendTitle(c,"WHERE"+a);1==a&&this.moveInputBefore("AT1","AT2")}};Blockly.Language.text_getSubstring.WHERE1=[[Blockly.LANG_TEXT_SUBSTRING_FROM_START,"FROM_START"],[Blockly.LANG_TEXT_SUBSTRING_FROM_END,"FROM_END"],[Blockly.LANG_TEXT_SUBSTRING_FIRST,"FIRST"]];
...
Blockly.Language.lists_create_with_container={init:function(){this.setColour(Blockly.Language.LIST_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_LISTS_CREATE_WITH_CONTAINER_TITLE_ADD);this.appendStatementInput("STACK");this.setTooltip(Blockly.LANG_LISTS_CREATE_WITH_CONTAINER_TOOLTIP);this.contextMenu=!1}};
Blockly.Language.lists_create_with_item={init:function(){this.setColour(Blockly.Language.LIST_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_LISTS_CREATE_WITH_ITEM_TITLE);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.LANG_LISTS_CREATE_WITH_ITEM_TOOLTIP);this.contextMenu=!1}};
Blockly.Language.lists_repeat={helpUrl:Blockly.LANG_LISTS_REPEAT_HELPURL,init:function(){this.setColour(Blockly.Language.LIST_TYPE_HUE);this.setOutput(!0,"Array");this.appendValueInput("ITEM").appendTitle(Blockly.LANG_LISTS_REPEAT_INPUT_WITH);this.appendValueInput("NUM").setCheck("Number").appendTitle(Blockly.LANG_LISTS_REPEAT_INPUT_REPEATED);this.appendDummyInput().appendTitle(Blockly.LANG_LISTS_REPEAT_INPUT_TIMES);this.setInputsInline(!0);this.setTooltip(Blockly.LANG_LISTS_REPEAT_TOOLTIP)}};
Blockly.Language.lists_length={helpUrl:Blockly.LANG_LISTS_LENGTH_HELPURL,init:function(){this.setColour(Blockly.Language.LIST_TYPE_HUE);this.appendValueInput("VALUE").setCheck(["Array","String"]).appendTitle(Blockly.LANG_LISTS_LENGTH_INPUT_LENGTH);this.setOutput(!0,"Number");this.setTooltip(Blockly.LANG_LISTS_LENGTH_TOOLTIP)}};
...
Blockly.Language.lists_getSublist={helpUrl:Blockly.LANG_LISTS_GET_SUBLIST_HELPURL,init:function(){this.setColour(Blockly.Language.LIST_TYPE_HUE);this.appendValueInput("LIST").setCheck("Array").appendTitle(Blockly.LANG_LISTS_GET_SUBLIST_INPUT_IN_LIST);this.appendDummyInput("AT1");this.appendDummyInput("AT2");this.setInputsInline(!0);this.setOutput(!0,"Array");this.updateAt(1,!0);this.updateAt(2,!0);this.setTooltip(Blockly.LANG_LISTS_GET_SUBLIST_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation"),
b=this.getInput("AT1").type==Blockly.INPUT_VALUE;a.setAttribute("at1",b);b=this.getInput("AT2").type==Blockly.INPUT_VALUE;a.setAttribute("at2",b);return a},domToMutation:function(a){var b="true"==a.getAttribute("at1");a="true"==a.getAttribute("at1");this.updateAt(1,b);this.updateAt(2,a)},updateAt:function(a,b){this.removeInput("AT"+a);b?this.appendValueInput("AT"+a).setCheck("Number"):this.appendDummyInput("AT"+a);var c=new Blockly.FieldDropdown(this["WHERE"+a],function(c){var e="FROM_START"==c||
"FROM_END"==c;if(e!=b){var f=this.sourceBlock_;f.updateAt(a,e);f.setTitleValue(c,"WHERE"+a);return null}});this.getInput("AT"+a).appendTitle(Blockly["LANG_LISTS_GET_SUBLIST_INPUT_AT"+a]).appendTitle(c,"WHERE"+a);1==a&&this.moveInputBefore("AT1","AT2")}};Blockly.Language.lists_getSublist.WHERE1=Blockly.Language.lists_getIndex.WHERE.filter(function(a){return"FROM_START"==a[1]||"FROM_END"==a[1]||"FIRST"==a[1]});
Blockly.Language.lists_getSublist.WHERE2=Blockly.Language.lists_getIndex.WHERE.filter(function(a){return"FROM_START"==a[1]||"FROM_END"==a[1]||"LAST"==a[1]});Blockly.Language.LOGIC_TYPE_HUE=210;
Blockly.Language.controls_if={helpUrl:Blockly.LANG_CONTROLS_IF_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.appendValueInput("IF0").setCheck("Boolean").appendTitle(Blockly.LANG_CONTROLS_IF_MSG_IF);this.appendStatementInput("DO0").appendTitle(Blockly.LANG_CONTROLS_IF_MSG_THEN);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setMutator(new Blockly.Mutator(["controls_if_elseif","controls_if_else"]));var a=this;this.setTooltip(function(){if(a.elseifCount_||a.elseCount_){if(!a.elseifCount_&&
...
b++;break;case "controls_if_else":d=this.getInput("ELSE");a.statementConnection_=d&&d.connection.targetConnection;break;default:throw"Unknown block type.";}a=a.nextConnection&&a.nextConnection.targetBlock()}}};Blockly.Language.controls_if_if={init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_IF_IF_TITLE_IF);this.appendStatementInput("STACK");this.setTooltip(Blockly.LANG_CONTROLS_IF_IF_TOOLTIP);this.contextMenu=!1}};
Blockly.Language.controls_if_elseif={init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_IF_ELSEIF_TITLE_ELSEIF);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.LANG_CONTROLS_IF_ELSEIF_TOOLTIP);this.contextMenu=!1}};
Blockly.Language.controls_if_else={init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_IF_ELSE_TITLE_ELSE);this.setPreviousStatement(!0);this.setTooltip(Blockly.LANG_CONTROLS_IF_ELSE_TOOLTIP);this.contextMenu=!1}};
Blockly.Language.logic_compare={helpUrl:Blockly.LANG_LOGIC_COMPARE_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.setOutput(!0,"Boolean");this.appendValueInput("A");this.appendValueInput("B").appendTitle(new Blockly.FieldDropdown(this.OPERATORS),"OP");this.setInputsInline(!0);var a=this;this.setTooltip(function(){var b=a.getTitleValue("OP");return a.TOOLTIPS[b]})}};
Blockly.Language.logic_compare.OPERATORS=[["=","EQ"],["\u2260","NEQ"],["<","LT"],["\u2264","LTE"],[">","GT"],["\u2265","GTE"]];Blockly.Language.logic_compare.TOOLTIPS={EQ:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_EQ,NEQ:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_NEQ,LT:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LT,LTE:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_LTE,GT:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GT,GTE:Blockly.LANG_LOGIC_COMPARE_TOOLTIP_GTE};
...
Blockly.Language.logic_operation.OPERATORS=[[Blockly.LANG_LOGIC_OPERATION_AND,"AND"],[Blockly.LANG_LOGIC_OPERATION_OR,"OR"]];Blockly.Language.logic_operation.TOOLTIPS={AND:Blockly.LANG_LOGIC_OPERATION_TOOLTIP_AND,OR:Blockly.LANG_LOGIC_OPERATION_TOOLTIP_OR};
Blockly.Language.logic_negate={helpUrl:Blockly.LANG_LOGIC_NEGATE_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.setOutput(!0,"Boolean");this.appendValueInput("BOOL").setCheck("Boolean").appendTitle(Blockly.LANG_LOGIC_NEGATE_INPUT_NOT);this.setTooltip(Blockly.LANG_LOGIC_NEGATE_TOOLTIP)}};
Blockly.Language.logic_boolean={helpUrl:Blockly.LANG_LOGIC_BOOLEAN_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.setOutput(!0,"Boolean");this.appendDummyInput().appendTitle(new Blockly.FieldDropdown(this.BOOLEANS),"BOOL");this.setTooltip(Blockly.LANG_LOGIC_BOOLEAN_TOOLTIP)}};Blockly.Language.logic_boolean.BOOLEANS=[[Blockly.LANG_LOGIC_BOOLEAN_TRUE,"TRUE"],[Blockly.LANG_LOGIC_BOOLEAN_FALSE,"FALSE"]];
Blockly.Language.logic_null={helpUrl:Blockly.LANG_LOGIC_NULL_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.setOutput(!0);this.appendDummyInput().appendTitle(Blockly.LANG_LOGIC_NULL);this.setTooltip(Blockly.LANG_LOGIC_NULL_TOOLTIP)}};
Blockly.Language.logic_ternary={helpUrl:Blockly.LANG_LOGIC_TERNARY_HELPURL,init:function(){this.setColour(Blockly.Language.LOGIC_TYPE_HUE);this.appendValueInput("IF").setCheck("Boolean").appendTitle(Blockly.LANG_LOGIC_TERNARY_CONDITION);this.appendValueInput("THEN").appendTitle(Blockly.LANG_LOGIC_TERNARY_IF_TRUE);this.appendValueInput("ELSE").appendTitle(Blockly.LANG_LOGIC_TERNARY_IF_FALSE);this.setOutput(!0);this.setTooltip(Blockly.LANG_LOGIC_TERNARY_TOOLTIP)}};Blockly.Language.LOOPS_TYPE_HUE=120;
Blockly.Language.controls_repeat={helpUrl:Blockly.LANG_CONTROLS_REPEAT_HELPURL,init:function(){this.setColour(Blockly.Language.LOOPS_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_REPEAT_TITLE_REPEAT).appendTitle(new Blockly.FieldTextInput("10",Blockly.FieldTextInput.nonnegativeIntegerValidator),"TIMES").appendTitle(Blockly.LANG_CONTROLS_REPEAT_TITLE_TIMES);this.appendStatementInput("DO").appendTitle(Blockly.LANG_CONTROLS_REPEAT_INPUT_DO);this.setPreviousStatement(!0);this.setNextStatement(!0);
...
this.setInputsInline(!0);this.setTooltip(Blockly.LANG_CONTROLS_REPEAT_TOOLTIP)}};
...
Blockly.Language.controls_for={helpUrl:Blockly.LANG_CONTROLS_FOR_HELPURL,init:function(){this.setColour(Blockly.Language.LOOPS_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_FOR_INPUT_WITH).appendTitle(new Blockly.FieldVariable(null),"VAR");this.appendValueInput("FROM").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_CONTROLS_FOR_INPUT_FROM);this.appendValueInput("TO").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_CONTROLS_FOR_INPUT_TO);
this.appendValueInput("BY").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_CONTROLS_FOR_INPUT_BY);Blockly.LANG_CONTROLS_FOR_TAIL&&this.appendDummyInput().appendTitle(Blockly.LANG_CONTROLS_FOR_TAIL);this.appendStatementInput("DO").appendTitle(Blockly.LANG_CONTROLS_FOR_INPUT_DO);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setInputsInline(!0);var a=this;this.setTooltip(function(){return Blockly.LANG_CONTROLS_FOR_TOOLTIP.replace("%1",a.getTitleValue("VAR"))})},
getVars:function(){return[this.getTitleValue("VAR")]},renameVar:function(a,b){Blockly.Names.equals(a,this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},customContextMenu:function(a){var b={enabled:!0},c=this.getTitleValue("VAR");b.text=Blockly.LANG_VARIABLES_SET_CREATE_GET.replace("%1",c);c=goog.dom.createDom("title",null,c);c.setAttribute("name","VAR");c=goog.dom.createDom("block",null,c);c.setAttribute("type","variables_get");b.callback=Blockly.ContextMenu.callbackFactory(this,c);a.push(b)}};
...
this.appendStatementInput("DO").appendTitle(Blockly.LANG_CONTROLS_FOREACH_INPUT_DO);this.setPreviousStatement(!0);this.setNextStatement(!0);var a=this;this.setTooltip(function(){return Blockly.LANG_CONTROLS_FOREACH_TOOLTIP.replace("%1",a.getTitleValue("VAR"))})},getVars:function(){return[this.getTitleValue("VAR")]},renameVar:function(a,b){Blockly.Names.equals(a,this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},customContextMenu:Blockly.Language.controls_for.customContextMenu};
Blockly.Language.controls_flow_statements={helpUrl:Blockly.LANG_CONTROLS_FLOW_STATEMENTS_HELPURL,init:function(){this.setColour(Blockly.Language.LOOPS_TYPE_HUE);this.appendDummyInput().appendTitle(new Blockly.FieldDropdown(this.OPERATORS),"FLOW");this.setPreviousStatement(!0);var a=this;this.setTooltip(function(){var b=a.getTitleValue("FLOW");return a.TOOLTIPS[b]})},onchange:function(){if(this.workspace){var a=!1,b=this;do{if("controls_repeat"==b.type||"controls_forEach"==b.type||"controls_for"==
b.type||"controls_whileUntil"==b.type){a=!0;break}b=b.getSurroundParent()}while(b);a?this.setWarningText(null):this.setWarningText(Blockly.LANG_CONTROLS_FLOW_STATEMENTS_WARNING)}}};Blockly.Language.controls_flow_statements.OPERATORS=[[Blockly.LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK,"BREAK"],[Blockly.LANG_CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE,"CONTINUE"]];Blockly.Language.controls_flow_statements.TOOLTIPS={BREAK:Blockly.LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK,CONTINUE:Blockly.LANG_CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE};Blockly.Language.COLOUR_TYPE_HUE=20;Blockly.Language.colour_picker={helpUrl:Blockly.LANG_COLOUR_PICKER_HELPURL,init:function(){this.setColour(Blockly.Language.COLOUR_TYPE_HUE);this.appendDummyInput().appendTitle(new Blockly.FieldColour("#ff0000"),"COLOUR");this.setOutput(!0,"Colour");this.setTooltip(Blockly.LANG_COLOUR_PICKER_TOOLTIP)}};
Blockly.Language.colour_random={helpUrl:Blockly.LANG_COLOUR_RANDOM_HELPURL,init:function(){this.setColour(Blockly.Language.COLOUR_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_COLOUR_RANDOM_TITLE);this.setOutput(!0,"Colour");this.setTooltip(Blockly.LANG_COLOUR_RANDOM_TOOLTIP)}};
Blockly.Language.colour_rgb={helpUrl:Blockly.LANG_COLOUR_RGB_HELPURL,init:function(){this.setColour(Blockly.Language.COLOUR_TYPE_HUE);this.appendValueInput("RED").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_RGB_TITLE).appendTitle(Blockly.LANG_COLOUR_RGB_RED);this.appendValueInput("GREEN").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_RGB_GREEN);this.appendValueInput("BLUE").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_RGB_BLUE);
this.setOutput(!0,"Colour");this.setTooltip(Blockly.LANG_COLOUR_RGB_TOOLTIP)}};
Blockly.Language.colour_blend={helpUrl:Blockly.LANG_COLOUR_BLEND_HELPURL,init:function(){this.setColour(Blockly.Language.COLOUR_TYPE_HUE);this.appendValueInput("COLOUR1").setCheck("Colour").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_BLEND_TITLE).appendTitle(Blockly.LANG_COLOUR_BLEND_COLOUR1);this.appendValueInput("COLOUR2").setCheck("Colour").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_BLEND_COLOUR2);this.appendValueInput("RATIO").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendTitle(Blockly.LANG_COLOUR_BLEND_RATIO);
this.setOutput(!0,"Colour");this.setTooltip(Blockly.LANG_COLOUR_BLEND_TOOLTIP)}};Blockly.Language.MATH_TYPE_HUE=230;Blockly.Language.math_number={helpUrl:Blockly.LANG_MATH_NUMBER_HELPURL,init:function(){this.setColour(Blockly.Language.MATH_TYPE_HUE);this.appendDummyInput().appendTitle(new Blockly.FieldTextInput("0",Blockly.FieldTextInput.numberValidator),"NUM");this.setOutput(!0,"Number");this.setTooltip(Blockly.LANG_MATH_NUMBER_TOOLTIP)}};
Blockly.Language.math_arithmetic={helpUrl:Blockly.LANG_MATH_ARITHMETIC_HELPURL,init:function(){this.setColour(Blockly.Language.MATH_TYPE_HUE);this.setOutput(!0,"Number");this.appendValueInput("A").setCheck("Number");this.appendValueInput("B").setCheck("Number").appendTitle(new Blockly.FieldDropdown(this.OPERATORS),"OP");this.setInputsInline(!0);var a=this;this.setTooltip(function(){var b=a.getTitleValue("OP");return a.TOOLTIPS[b]})}};
...
Blockly.Language.math_constant={helpUrl:Blockly.LANG_MATH_CONSTANT_HELPURL,init:function(){this.setColour(Blockly.Language.MATH_TYPE_HUE);this.setOutput(!0,"Number");this.appendDummyInput().appendTitle(new Blockly.FieldDropdown(this.CONSTANTS),"CONSTANT");this.setTooltip(Blockly.LANG_MATH_CONSTANT_TOOLTIP)}};Blockly.Language.math_constant.CONSTANTS=[["\u03c0","PI"],["e","E"],["\u03c6","GOLDEN_RATIO"],["sqrt(2)","SQRT2"],["sqrt(\u00bd)","SQRT1_2"],["\u221e","INFINITY"]];
Blockly.Language.math_number_property={helpUrl:"",init:function(){this.setColour(Blockly.Language.MATH_TYPE_HUE);this.appendValueInput("NUMBER_TO_CHECK").setCheck("Number");var a=new Blockly.FieldDropdown(this.PROPERTIES,function(a){this.sourceBlock_.updateShape("DIVISIBLE_BY"==a)});this.appendDummyInput().appendTitle(a,"PROPERTY");this.setInputsInline(!0);this.setOutput(!0,"Boolean");this.setTooltip(Blockly.LANG_MATH_IS_TOOLTIP)},mutationToDom:function(){var a=document.createElement("mutation"),
b="DIVISIBLE_BY"==this.getTitleValue("PROPERTY");a.setAttribute("divisor_input",b);return a},domToMutation:function(a){a="true"==a.getAttribute("divisor_input");this.updateShape(a)},updateShape:function(a){var b=this.getInput("DIVISOR");a?b||this.appendValueInput("DIVISOR").setCheck("Number"):b&&this.removeInput("DIVISOR")}};
...
Blockly.Language.math_on_list={helpUrl:Blockly.LANG_MATH_ONLIST_HELPURL,init:function(){var a=this;this.setColour(Blockly.Language.MATH_TYPE_HUE);this.setOutput(!0,"Number");var b=new Blockly.FieldDropdown(this.OPERATORS,function(b){"MODE"==b?a.outputConnection.setCheck("Array"):a.outputConnection.setCheck("Number")});this.appendValueInput("LIST").setCheck("Array").appendTitle(b,"OP");this.setTooltip(function(){var b=a.getTitleValue("OP");return a.TOOLTIPS[b]})}};
...
Blockly.Language.math_random_float={helpUrl:Blockly.LANG_MATH_RANDOM_FLOAT_HELPURL,init:function(){this.setColour(Blockly.Language.MATH_TYPE_HUE);this.setOutput(!0,"Number");this.appendDummyInput().appendTitle(Blockly.LANG_MATH_RANDOM_FLOAT_TITLE_RANDOM);this.setTooltip(Blockly.LANG_MATH_RANDOM_FLOAT_TOOLTIP)}};Blockly.Language.VARIABLE_TYPE_HUE=210;
Blockly.Language.variables_get={category:null,helpUrl:Blockly.LANG_VARIABLES_GET_HELPURL,init:function(){this.setColour(Blockly.Language.VARIABLE_TYPE_HUE);this.appendDummyInput().appendTitle(Blockly.LANG_VARIABLES_GET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.LANG_VARIABLES_GET_ITEM),"VAR").appendTitle(Blockly.LANG_VARIABLES_GET_TAIL);this.setOutput(!0);this.setTooltip(Blockly.LANG_VARIABLES_GET_TOOLTIP)},getVars:function(){return[this.getTitleValue("VAR")]},renameVar:function(a,b){Blockly.Names.equals(a,
this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},contextMenuMsg_:Blockly.LANG_VARIABLES_GET_CREATE_SET,contextMenuType_:"variables_set",customContextMenu:function(a){var b={enabled:!0},c=this.getTitleValue("VAR");b.text=this.contextMenuMsg_.replace("%1",c);c=goog.dom.createDom("title",null,c);c.setAttribute("name","VAR");c=goog.dom.createDom("block",null,c);c.setAttribute("type",this.contextMenuType_);b.callback=Blockly.ContextMenu.callbackFactory(this,c);a.push(b)}};
Blockly.Language.variables_set={category:null,helpUrl:Blockly.LANG_VARIABLES_SET_HELPURL,init:function(){this.setColour(Blockly.Language.VARIABLE_TYPE_HUE);this.appendValueInput("VALUE").appendTitle(Blockly.LANG_VARIABLES_SET_TITLE).appendTitle(new Blockly.FieldVariable(Blockly.LANG_VARIABLES_SET_ITEM),"VAR").appendTitle(Blockly.LANG_VARIABLES_SET_TAIL);this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.LANG_VARIABLES_SET_TOOLTIP)},getVars:function(){return[this.getTitleValue("VAR")]},
renameVar:function(a,b){Blockly.Names.equals(a,this.getTitleValue("VAR"))&&this.setTitleValue(b,"VAR")},contextMenuMsg_:Blockly.LANG_VARIABLES_SET_CREATE_GET,contextMenuType_:"variables_get",customContextMenu:Blockly.Language.variables_get.customContextMenu};/*global Blockly, document, window, location*/var eflang=function(){"use strict";function r(e){return{category:n.LANG_CATEGORY_PROCS,returns:e,helpUrl:"",init:function(){this.setColour(t.PROCEDURE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_PROCS_CALL_WITH_NAME).appendTitle(new n.FieldTextInput(n.LANG_PROCS_CALL_NAME),"NAME"),this.appendValueInput("ADD0").appendTitle(n.LANG_PROCS_CALL_WITH_INPUT_WITH),this.appendValueInput("ADD1"),e?this.setOutput(!0,null):(this.setPreviousStatement(!0),this.setNextStatement(!0)),this.setMutator(new n.Mutator(["procs_call_with_item"])),this.setTooltip(n.LANG_PROCS_CALL_WITH_TOOLTIP_1),this.itemCount_=2},mutationToDom:function(e){var t=document.createElement("mutation");return t.setAttribute("items",this.itemCount_),t},domToMutation:function(e){var t,r;for(t=0;t<this.itemCount_;t+=1)this.removeInput("ADD"+t);this.itemCount_=window.parseInt(e.getAttribute("items"),10);for(t=0;t<this.itemCount_;t+=1)r=this.appendValueInput("ADD"+t),t===0&&r.appendTitle(n.LANG_PROCS_CALL_WITH_INPUT_WITH);this.itemCount_===0&&this.appendDummyInput("EMPTY").appendTitle(n.LANG_PROCS_CALL_EMPTY_TITLE_1)},decompose:function(e){var t,r,i,s=new n.Block(e,"procs_call_with_container");s.initSvg(),r=s.getInput("STACK").connection;for(t=0;t<this.itemCount_;t+=1)i=new n.Block(e,"procs_call_with_item"),i.initSvg(),r.connect(i.previousConnection),r=i.nextConnection;return s},compose:function(e){var t,r,i;if(this.itemCount_===0)this.removeInput("EMPTY");else for(t=this.itemCount_-1;t>=0;t-=1)this.removeInput("ADD"+t);this.itemCount_=0,r=e.getInputTargetBlock("STACK");while(r)i=this.appendValueInput("ADD"+this.itemCount_),this.itemCount_===0&&i.appendTitle(n.LANG_PROCS_CALL_WITH_INPUT_WITH),r.valueConnection_&&i.connection.connect(r.valueConnection_),this.itemCount_+=1,r=r.nextConnection&&r.nextConnection.targetBlock();this.itemCount_===0&&this.appendDummyInput("EMPTY").appendTitle(n.LANG_PROCS_CALL_EMPTY_TITLE_1)},saveConnections:function(e){var t=0,n,r=e.getInputTargetBlock("STACK");while(r)n=this.getInput("ADD"+t),r.valueConnection_=n&&n.connection.targetConnection,t+=1,r=r.nextConnection&&r.nextConnection.targetBlock()}}}function i(){var e,t,n,r=location.search.slice(1),i={},s,o;t=r.split("&");for(e=0;e<t.length;e+=1){n=t[e].split("=");if(n.length!==2)continue;s=n[0].trim(),o=n[1].trim(),i[s]=o}return i}function s(){var e=i();window.parent["init"+e.id](n,e.id,document)}var e=Blockly.JavaScript,t=Blockly.Language,n=Blockly;return n.LANG_VARIABLES_GET_FIELD_INPUT_FIELD="get",n.LANG_VARIABLES_GET_FIELD_INPUT_IN="from object",n.LANG_VARIABLES_GET_FIELD_INPUT_FROM_TOOLTIP_1="Returns the value of field in an object.",n.LANG_VARIABLES_OUTGET_HELPURL="http://en.wikipedia.org/wiki/Variable_(computer_science)",n.LANG_VARIABLES_OUTGET_TITLE_1="get out var",n.LANG_VARIABLES_OUTGET_ITEM="item",n.LANG_VARIABLES_OUTGET_TOOLTIP_1="Returns the value of this output variable.",n.LANG_VARIABLES_OUTSET_HELPURL="http://en.wikipedia.org/wiki/Variable_(computer_science)",n.LANG_VARIABLES_OUTSET_TITLE_1="set out var",n.LANG_VARIABLES_OUTSET_ITEM="item",n.LANG_VARIABLES_OUTSET_TOOLTIP_1="Sets this output variable to be equal to the input.",n.LANG_CONST_OUTGET_TITLE_1="get constant",n.LANG_CONST_OUTGET_TOOLTIP_1="Returns the value of a constant",n.LANG_CATEGORY_OBJS="Objects",n.LANG_CATEGORY_PROCS="Procedures",n.LANG_PROCS_CALL_NAME="procedureName",n.LANG_PROCS_CALL_WITH_INPUT_WITH="with",n.LANG_PROCS_CALL_WITH_TOOLTIP_1="Call a procedure with any number of arguments.",n.LANG_PROCS_CALL_WITH_CONTAINER_TITLE_ADD="procedure",n.LANG_PROCS_CALL_WITH_CONTAINER_TOOLTIP_1="Add, remove, or reorder sections to reconfigure this procedure call.",n.LANG_PROCS_CALL_WITH_NAME="Call",n.LANG_PROCS_CALL_WITH_ITEM_TITLE="argument",n.LANG_PROCS_CALL_WITH_ITEM_TOOLTIP_1="Add an argument to the argument list.",n.LANG_OBJS_CREATE_WITH_INPUT_WITH="create object with",n.LANG_OBJS_CREATE_WITH_TOOLTIP_1="Create an object with any number of fields.",n.LANG_OBJS_CREATE_WITH_CONTAINER_TITLE_ADD="object",n.LANG_OBJS_CREATE_WITH_CONTAINER_TOOLTIP_1="Add, remove, or reorder sections to reconfigure this object block.",n.LANG_OBJS_CREATE_WITH_ITEM_TITLE="field",n.LANG_OBJS_CREATE_WITH_ITEM_TOOLTIP_1="Add a field to the object.",n.eflang={},n.eflang.constants=[["NAME","NAME"]],n.eflang.constantsPath="libs.consts.",n.eflang.math_set_precision_fun="libs.format.floatPrecision",n.eflang.db_store_fun="libs.store.set",n.eflang.db_fetch_fun="libs.store.get",n.eflang.db_incr_fun="libs.store.incr",n.eflang.db_decr_fun="libs.store.decr",t.const_get={category:"Output",init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_CONST_OUTGET_TITLE_1).appendTitle(new n.FieldDropdown(n.eflang.constants),"CONST"),this.setOutput(!0,null),this.setTooltip(n.LANG_CONST_OUTGET_TOOLTIP_1)},getVars:function(){return[]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("VAR"))&&this.setTitleValue(t,"VAR")}},t.variables_outget={category:"Output",helpUrl:n.LANG_VARIABLES_GET_HELPURL,init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_VARIABLES_OUTGET_TITLE_1).appendTitle(new n.FieldTextInput(n.LANG_VARIABLES_GET_ITEM),"VAR"),this.setOutput(!0,null),this.setTooltip(n.LANG_VARIABLES_OUTGET_TOOLTIP_1)},getVars:function(){return[]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("VAR"))&&this.setTitleValue(t,"VAR")}},t.variables_outset={category:"Output",helpUrl:n.LANG_VARIABLES_OUTSET_HELPURL,init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendValueInput("VALUE").appendTitle(n.LANG_VARIABLES_OUTSET_TITLE_1).appendTitle(new n.FieldTextInput(n.LANG_VARIABLES_OUTSET_ITEM),"VAR"),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.LANG_VARIABLES_OUTSET_TOOLTIP_1)},getVars:function(){return[]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("VAR"))&&this.setTitleValue(t,"VAR")}},e.const_get=function(){var t=this.getTitleValue("CONST");return[n.eflang.constantsPath+t,e.ORDER_ATOMIC]},e.variables_outget=function(){var t=this.getTitleValue("VAR");return["env."+t,e.ORDER_ATOMIC]},e.variables_outset=function(){var t=e.valueToCode(this,"VALUE",e.ORDER_ASSIGNMENT)||"0",n=this.getTitleValue("VAR");return"env."+n+" = "+t+";\n"},n.LANG_VARIABLES_GETPATH_TITLE="get var path",n.LANG_VARIABLES_GETPATH_ITEM="item.child",n.LANG_VARIABLES_GETPATH_TOOLTIP="Returns the value of this path.",t.variables_getpath={category:"Output",helpUrl:n.LANG_VARIABLES_GET_HELPURL,init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_VARIABLES_GETPATH_TITLE).appendTitle(new n.FieldTextInput(n.LANG_VARIABLES_GETPATH_ITEM),"VAR"),this.setOutput(!0,null),this.setTooltip(n.LANG_VARIABLES_GETPATH_TOOLTIP)},getVars:function(){return[]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("VAR"))&&this.setTitleValue(t,"VAR")}},e.variables_getpath=function(){var t=this.getTitleValue("VAR");return[t,e.ORDER_ATOMIC]},e.objs_create_with=function(){var t,n=new Array(this.itemCount_);for(t=0;t<this.itemCount_;t+=1)n[t]=this.getTitleValue("FIELD"+t)+": "+(e.valueToCode(this,"FIELD"+t,e.ORDER_COMMA)||"null");return n="{"+n.join(", ")+"}",[n,e.ORDER_ATOMIC]},t.objs_create_with={category:n.LANG_CATEGORY_OBJS,helpUrl:"",addField:function(e,t){var r=this.appendValueInput("FIELD"+e);return r.appendTitle("key").appendTitle(new n.FieldTextInput(t||n.LANG_VARIABLES_OUTSET_ITEM),"FIELD"+e).appendTitle(":"),r},init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.addField(0),this.addField(1),this.addField(2),this.setOutput(!0,Array),this.setMutator(new n.Mutator(["objs_create_with_item"])),this.setTooltip(n.LANG_OBJS_CREATE_WITH_TOOLTIP_1),this.itemCount_=3},mutationToDom:function(e){var t=document.createElement("mutation");return t.setAttribute("items",this.itemCount_),t},domToMutation:function(e){var t,r;for(t=0;t<this.itemCount_;t+=1)this.removeInput("FIELD"+t);this.itemCount_=window.parseInt(e.getAttribute("items"),10);for(t=0;t<this.itemCount_;t+=1)r=this.addField(t);this.itemCount_===0&&this.appendDummyInput("EMPTY").appendTitle(n.LANG_OBJS_CREATE_EMPTY_TITLE_1)},decompose:function(e){var t,r,i,s=new n.Block(e,"objs_create_with_container");s.initSvg(),t=s.getInput("STACK").connection;for(r=0;r<this.itemCount_;r+=1)i=new n.Block(e,"objs_create_with_item"),i.initSvg(),t.connect(i.previousConnection),t=i.nextConnection;return s},compose:function(e){var t,r,i,s,o,u=[];if(this.itemCount_===0)this.removeInput("EMPTY");else for(t=this.itemCount_-1;t>=0;t-=1)u.push(this.getInput("FIELD"+t)),this.removeInput("FIELD"+t);u.reverse(),this.itemCount_=0,r=e.getInputTargetBlock("STACK");while(r)i=u[this.itemCount_],s=i?i.titleRow[1].getText():null,o=this.addField(this.itemCount_,s),r.valueConnection_&&o.connection.connect(r.valueConnection_),this.itemCount_+=1,r=r.nextConnection&&r.nextConnection.targetBlock();this.itemCount_===0&&this.appendDummyInput("EMPTY").appendTitle(n.LANG_OBJS_CREATE_EMPTY_TITLE_1)},saveConnections:function(e){var t,n=e.getInputTargetBlock("STACK"),r=0;while(n)t=this.getInput("FIELD"+r),n.valueConnection_=t&&t.connection.targetConnection,r+=1,n=n.nextConnection&&n.nextConnection.targetBlock()}},t.objs_create_with_container={init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_OBJS_CREATE_WITH_CONTAINER_TITLE_ADD),this.appendStatementInput("STACK"),this.setTooltip(n.LANG_OBJS_CREATE_WITH_CONTAINER_TOOLTIP_1),this.contextMenu=!1}},t.objs_create_with_item={init:function(){this.setColour(t.VARIABLE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_OBJS_CREATE_WITH_ITEM_TITLE),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.LANG_OBJS_CREATE_WITH_ITEM_TOOLTIP_1),this.contextMenu=!1}},e.procs_call_with=function(){var t,n=this.getTitleValue("NAME"),r=new Array(this.itemCount_);for(t=0;t<this.itemCount_;t+=1)r[t]=e.valueToCode(this,"ADD"+t,e.ORDER_COMMA)||"null";return r="libs."+n+"("+r.join(", ")+")",this.returns?[r,e.ORDER_ATOMIC]:r+";\n"},e.procs_call_with_no_return=e.procs_call_with,t.procs_call_with=r(!0),t.procs_call_with_no_return=r(!1),t.procs_call_with_container={init:function(){this.setColour(t.PROCEDURE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_PROCS_CALL_WITH_CONTAINER_TITLE_ADD),this.appendStatementInput("STACK"),this.setTooltip(n.LANG_PROCS_CALL_WITH_CONTAINER_TOOLTIP_1),this.contextMenu=!1}},t.procs_call_with_item={init:function(){this.setColour(t.PROCEDURE_TYPE_HUE),this.appendDummyInput().appendTitle(n.LANG_PROCS_CALL_WITH_ITEM_TITLE),this.setPreviousStatement(!0),this.setNextStatement(!0),this.setTooltip(n.LANG_PROCS_CALL_WITH_ITEM_TOOLTIP_1),this.contextMenu=!1}},n.LANG_CONTROLS_FOREACH_OBJ_HELPURL="http://en.wikipedia.org/wiki/For_loop",n.LANG_CONTROLS_FOREACH_OBJ_INPUT_ITEM="for each ",n.LANG_CONTROLS_FOREACH_OBJ_INPUT_VAR="x",n.LANG_CONTROLS_FOREACH_OBJ_INPUT_INLIST="in object",n.LANG_CONTROLS_FOREACH_OBJ_INPUT_DO="do",n.LANG_CONTROLS_FOREACH_OBJ_TOOLTIP='For each key, value in an object, set the key to\nvariable "%1", value to variable "%2" and then do some statements.',t.controls_forEach_object={category:n.LANG_CATEGORY_OBJS,helpUrl:n.LANG_CONTROLS_FOREACH_OBJ_HELPURL,init:function(){this.setColour(t.LOOPS_TYPE_HUE),this.appendValueInput("OBJ").setCheck(Array).appendTitle(n.LANG_CONTROLS_FOREACH_OBJ_INPUT_ITEM).appendTitle(new n.FieldVariable("key"),"KEY").appendTitle(", ").appendTitle(new n.FieldVariable("value"),"VAL").appendTitle(n.LANG_CONTROLS_FOREACH_OBJ_INPUT_INLIST),this.appendStatementInput("DO").appendTitle(n.LANG_CONTROLS_FOREACH_OBJ_INPUT_DO),this.setPreviousStatement(!0),this.setNextStatement(!0);var e=this;this.setTooltip(function(){return n.LANG_CONTROLS_FOREACH_OBJ_TOOLTIP.replace("%1",e.getTitleValue("KEY")).replace("%2",e.getTitleValue("VAL"))})},getVars:function(){return[this.getTitleValue("KEY"),this.getTitleValue("VAL")]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("KEY"))?this.setTitleValue(t,"KEY"):n.Names.equals(e,this.getTitleValue("VAL"))&&this.setTitleValue(t,"VAL")}},e.controls_forEach_object=function(){var t,r,i=e.variableDB_.getName(this.getTitleValue("KEY"),n.Variables.NAME_TYPE),s=e.variableDB_.getName(this.getTitleValue("VAL"),n.Variables.NAME_TYPE),o=e.valueToCode(this,"OBJ",e.ORDER_ASSIGNMENT)||"[]",u=e.statementToCode(this,"DO");return e.INFINITE_LOOP_TRAP&&(u=e.INFINITE_LOOP_TRAP.replace(/%1/g,"'"+this.id+"'")+u),o.match(/^\w+$/)?(u="  "+s+" = "+o+"["+i+"];\n"+u,t="for (var "+i+" in  "+o+") {\n"+u+"}\n"):(r=e.variableDB_.getDistinctName(i+"_list",n.Variables.NAME_TYPE),u="  "+s+" = "+r+"["+i+"];\n"+u,t="var "+r+" = "+o+";\n"+"for (var "+i+" in "+r+") {\n"+u+"}\n"),t},n.LANG_LISTS_OPS_INPUT_IN_LIST="in list",n.LANG_LISTS_OPS_TOOLTIP_APPEND="Append an item to a list.",n.LANG_LISTS_OPS_APPEND="append",t.lists_ops={category:n.LANG_CATEGORY_LISTS,init:function(){this.setColour(t.LIST_TYPE_HUE);var e,r=new n.FieldDropdown(this.MODE,function(e){var t=e==="APPEND";this.sourceBlock_.updateStatement(t)});this.appendDummyInput().appendTitle(r,"MODE"),this.appendValueInput("ITEM").appendTitle("item"),this.appendValueInput("VALUE").setCheck(Array).appendTitle(n.LANG_LISTS_OPS_INPUT_IN_LIST),this.setInputsInline(!0),this.setOutput(!0,null),this.updateStatement(!0),e=this,this.setTooltip(function(){var t=e.getTitleValue("MODE");return n["LANG_LISTS_OPS_TOOLTIP_"+t]})},mutationToDom:function(){var e=document.createElement("mutation"),t=!this.outputConnection;return e.setAttribute("statement",t),e},domToMutation:function(e){var t=e.getAttribute("statement")==="true";this.updateStatement(t)},updateStatement:function(e){var t=!this.outputConnection;e!==t&&(this.unplug(!0,!0),e?(this.setOutput(!1),this.setPreviousStatement(!0),this.setNextStatement(!0)):(this.setPreviousStatement(!1),this.setNextStatement(!1),this.setOutput(!0)))}},e.lists_ops=function(){var t=this.getTitleValue("MODE"),n=e.valueToCode(this,"ITEM",e.ORDER_UNARY_NEGATION)||"null",r=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"[]";if(t==="APPEND")return r+".push("+n+");\n";throw"Unhandled combination (lists_ops)."},t.lists_ops.MODE=[[n.LANG_LISTS_OPS_APPEND,"APPEND"]],n.LANG_CONTROLS_ENUMERATE_HELPURL="http://en.wikipedia.org/wiki/For_loop",n.LANG_CONTROLS_ENUMERATE_INPUT_ITEM="for each",n.LANG_CONTROLS_ENUMERATE_INPUT_VAR="x",n.LANG_CONTROLS_ENUMERATE_INPUT_INDEX="#",n.LANG_CONTROLS_ENUMERATE_INPUT_INLIST="in list",n.LANG_CONTROLS_ENUMERATE_INPUT_DO="do",n.LANG_CONTROLS_ENUMERATE_TOOLTIP='For each item in a list, set the item to\nvariable "%1", the index of it to "%2" and then do some statements.',t.controls_enumerate={category:n.LANG_CATEGORY_CONTROLS,helpUrl:n.LANG_CONTROLS_ENUMERATE_HELPURL,init:function(){this.setColour(t.LOOPS_TYPE_HUE),this.appendValueInput("LIST").setCheck(Array).appendTitle(n.LANG_CONTROLS_ENUMERATE_INPUT_ITEM).appendTitle(new n.FieldVariable("item"),"VAR").appendTitle(n.LANG_CONTROLS_ENUMERATE_INPUT_INDEX).appendTitle(new n.FieldVariable("i"),"INDEX").appendTitle(n.LANG_CONTROLS_ENUMERATE_INPUT_INLIST),this.appendStatementInput("DO").appendTitle(n.LANG_CONTROLS_ENUMERATE_INPUT_DO),this.setPreviousStatement(!0),this.setNextStatement(!0);var e=this;this.setTooltip(function(){return n.LANG_CONTROLS_ENUMERATE_TOOLTIP.replace("%1",e.getTitleValue("VAR")).replace("%2",e.getTitleValue("INDEX"))})},getVars:function(){return[this.getTitleValue("VAR"),this.getTitleValue("INDEX")]},renameVar:function(e,t){n.Names.equals(e,this.getTitleValue("VAR"))?this.setTitleValue(t,"VAR"):n.Names.equals(e,this.getTitleValue("INDEX"))&&this.setTitleValue(t,"INDEX")}},e.controls_enumerate=function(){var t,r,i=e.variableDB_.getName(this.getTitleValue("VAR"),n.Variables.NAME_TYPE),s=e.variableDB_.getName(this.getTitleValue("INDEX"),n.Variables.NAME_TYPE),o=e.valueToCode(this,"LIST",e.ORDER_ASSIGNMENT)||"[]",u=e.statementToCode(this,"DO");return e.INFINITE_LOOP_TRAP&&(u=e.INFINITE_LOOP_TRAP.replace(/%1/g,"'"+this.id+"'")+u),o.match(/^\w+$/)?(u="  "+i+" = "+o+"["+s+" - 1];\n"+u,t="for (var "+s+" = 1; "+s+" <= "+o+".length; "+s+" += 1) {\n"+u+"}\n"):(r=e.variableDB_.getDistinctName(i+"_list",n.Variables.NAME_TYPE),u="  "+i+" = "+r+"["+s+" - 1];\n"+u,t="var "+r+" = "+o+";\n"+"for (var "+s+" = 1; "+s+" <= "+r+".length; "+s+" += 1) {\n"+u+"}\n"),t},n.LANG_MATH_PRECISION_INPUT="set precision of",n.LANG_MATH_PRECISION_INPUT_1="to",n.LANG_MATH_PRECISION_TOOLTIP="Truncate the decimal parts to a number of places",t.math_set_precision={init:function(){this.setColour(230),this.setOutput(!0,Number),this.appendValueInput("VALUE").setCheck(Number).appendTitle(n.LANG_MATH_PRECISION_INPUT),this.appendValueInput("PRECISION").setCheck(Number).setAlign(n.ALIGN_RIGHT).appendTitle(n.LANG_MATH_PRECISION_INPUT_1),this.setInputsInline(!0),this.setTooltip(n.LANG_MATH_PRECISION_TOOLTIP)}},e.math_set_precision=function(){var t=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"0",r=e.valueToCode(this,"PRECISION",e.ORDER_MEMBER)||"1",i=n.eflang.math_set_precision_fun+"("+t+", "+r+")";return[i,e.ORDER_FUNCTION_CALL]},n.LANG_DB_STORE_INPUT_1="store value",n.LANG_DB_STORE_INPUT="with key",n.LANG_DB_STORE_INPUT_2="in store",n.LANG_DB_STORE_TOOLTIP="Store value in the given key",t.db_store={init:function(){this.setColour(230),this.setOutput(!0,String),this.appendValueInput("VALUE").appendTitle(n.LANG_DB_STORE_INPUT_1),this.appendValueInput("KEY").setAlign(n.ALIGN_RIGHT).setCheck(String).appendTitle(n.LANG_DB_STORE_INPUT),this.appendValueInput("STORE").setAlign(n.ALIGN_RIGHT).setCheck(String).appendTitle(n.LANG_DB_STORE_INPUT_2),this.setInputsInline(!0),this.setTooltip(n.LANG_DB_STORE_TOOLTIP),this.setOutput(!1),this.setPreviousStatement(!0),this.setNextStatement(!0)}},e.db_store=function(){var t=e.valueToCode(this,"KEY",e.ORDER_MEMBER)||'"key"',r=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"1",i=e.valueToCode(this,"STORE",e.ORDER_MEMBER)||'"store"',s=n.eflang.db_store_fun+"("+i+", "+t+", "+r+");\n";return s},n.LANG_DB_FETCH_INPUT="fetch key",n.LANG_DB_FETCH_INPUT_1="value",n.LANG_DB_FETCH_INPUT_2="from store",n.LANG_DB_FETCH_TOOLTIP="Fetch value from the given key",t.db_fetch={init:function(){this.setColour(230),this.setOutput(!0,String),this.appendValueInput("KEY").setCheck(String).appendTitle(n.LANG_DB_FETCH_INPUT),this.appendValueInput("STORE").setAlign(n.ALIGN_RIGHT).setCheck(String).appendTitle(n.LANG_DB_FETCH_INPUT_2),this.setInputsInline(!0),this.setTooltip(n.LANG_DB_FETCH_TOOLTIP),this.setOutput(!0,null)}},e.db_fetch=function(){var t=e.valueToCode(this,"KEY",e.ORDER_MEMBER)||"key",r=e.valueToCode(this,"STORE",e.ORDER_MEMBER)||'"store"',i=n.eflang.db_fetch_fun+"("+r+", "+t+")";return[i,e.ORDER_FUNCTION_CALL]},n.LANG_DB_INCR_INPUT="increase key",n.LANG_DB_INCR_INPUT_1="from store",n.LANG_DB_INCR_TOOLTIP="Increase key in store and return it",t.db_incr={init:function(){this.setColour(230),this.setOutput(!0,String),this.appendValueInput("KEY").setCheck(String).appendTitle(n.LANG_DB_INCR_INPUT),this.appendValueInput("STORE").setAlign(n.ALIGN_RIGHT).setCheck(String).appendTitle(n.LANG_DB_INCR_INPUT_1),this.setInputsInline(!0),this.setTooltip(n.LANG_DB_INCR_TOOLTIP),this.setOutput(!0,null)}},e.db_incr=function(){var t=e.valueToCode(this,"KEY",e.ORDER_MEMBER)||"key",r=e.valueToCode(this,"STORE",e.ORDER_MEMBER)||'"store"',i=n.eflang.db_incr_fun+"("+r+", "+t+")";return[i,e.ORDER_FUNCTION_CALL]},n.LANG_DB_DECR_INPUT="decrease key",n.LANG_DB_DECR_INPUT_1="from store",n.LANG_DB_DECR_TOOLTIP="decrease key in store and return it",t.db_decr={init:function(){this.setColour(230),this.setOutput(!0,String),this.appendValueInput("KEY").setCheck(String).appendTitle(n.LANG_DB_DECR_INPUT),this.appendValueInput("STORE").setAlign(n.ALIGN_RIGHT).setCheck(String).appendTitle(n.LANG_DB_DECR_INPUT_1),this.setInputsInline(!0),this.setTooltip(n.LANG_DB_DECR_TOOLTIP),this.setOutput(!0,null)}},e.db_decr=function(){var t=e.valueToCode(this,"KEY",e.ORDER_MEMBER)||"key",r=e.valueToCode(this,"STORE",e.ORDER_MEMBER)||'"store"',i=n.eflang.db_decr_fun+"("+r+", "+t+")";return[i,e.ORDER_FUNCTION_CALL]},n.LANG_LOGIC_IS_NULL_INPUT="is null?",n.LANG_LOGIC_IS_NULL_TOOLTIP="Return true if value is null",t.logic_is_null={init:function(){this.setColour(t.LOGIC_TYPE_HUE),this.setOutput(!0,Boolean),this.appendValueInput("VALUE").appendTitle(n.LANG_LOGIC_IS_NULL_INPUT),this.setInputsInline(!0),this.setTooltip(n.LANG_LOGIC_IS_NULL_TOOLTIP)}},e.logic_is_null=function(){var t=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"null",n="("+t+" == null)";return[n,e.ORDER_ATOMIC]},t.logic_or_else={init:function(){this.setColour(t.LOGIC_TYPE_HUE),this.appendValueInput("VALUE").appendTitle("if"),this.appendValueInput("DEFAULT").appendTitle("otherwise").setAlign(n.ALIGN_RIGHT),this.setInputsInline(!0),this.setOutput(!0,null)}},e.logic_or_else=function(){var t=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"null",n=e.valueToCode(this,"DEFAULT",e.ORDER_MEMBER)||"null",r="("+t+" == null? "+n+" : "+t+")";return[r,e.ORDER_ATOMIC]},t.lists_contains={init:function(){this.setColour(t.LIST_TYPE_HUE),this.appendValueInput("VALUE"),this.appendValueInput("TOFIND").appendTitle("contains?").setAlign(n.ALIGN_RIGHT),this.setInputsInline(!0),this.setOutput(!0,Boolean)}},e.lists_contains=function(){var t=e.valueToCode(this,"VALUE",e.ORDER_MEMBER)||"null",n=e.valueToCode(this,"TOFIND",e.ORDER_MEMBER)||"null",r="("+t+".indexOf("+n+") !== -1)";return[r,e.ORDER_ATOMIC]},{init:s,B:n}}();