...
goog.Timer.TICK="tick";goog.Timer.callOnce=function(a,b,c){if(goog.isFunction(a))c&&(a=goog.bind(a,c));else if(a&&"function"==typeof a.handleEvent)a=goog.bind(a.handleEvent,a);else throw Error("Invalid listener argument");return b>goog.Timer.MAX_TIMEOUT_?-1:goog.Timer.defaultTimerObject.setTimeout(a,b||0)};goog.Timer.clear=function(a){goog.Timer.defaultTimerObject.clearTimeout(a)};Blockly.Trashcan=function(a){Blockly.Trashcan.superClass_.constructor.call(this);this.getMetrics_=a};goog.inherits(Blockly.Trashcan,goog.ui.Component);Blockly.Trashcan.prototype.BODY_URL_="media/trashbody.png";Blockly.Trashcan.prototype.LID_URL_="media/trashlid.png";Blockly.Trashcan.prototype.WIDTH_=47;Blockly.Trashcan.prototype.BODY_HEIGHT_=45;Blockly.Trashcan.prototype.LID_HEIGHT_=15;Blockly.Trashcan.prototype.MARGIN_BOTTOM_=35;Blockly.Trashcan.prototype.MARGIN_SIDE_=35;
...
Blockly.Bubble.prototype.dispose=function(){Blockly.Bubble.unbindDragEvents_();goog.dom.removeNode(this.bubbleGroup_);this.shape_=this.content_=this.workspace_=this.bubbleGroup_=null};Blockly.Mutator=function(a){Blockly.Mutator.superClass_.constructor.call(this);this.block_=null;this.quarkNames_=a};goog.inherits(Blockly.Mutator,goog.Disposable);Blockly.Mutator.ICON_SIZE=16;Blockly.Mutator.prototype.bubble_=null;Blockly.Mutator.prototype.iconX_=0;Blockly.Mutator.prototype.iconY_=0;Blockly.Mutator.prototype.workspaceWidth_=0;Blockly.Mutator.prototype.workspaceHeight_=0;
...
goog.Timer.callOnce(a.bumpNeighbours_,Blockly.BUMP_DELAY,a);Blockly.fireUiEvent(window,"resize");a.workspace.fireChangeEvent()}Blockly.Block.dragMode_=0};Blockly.Block.prototype.select=function(){Blockly.selected&&Blockly.selected.unselect();Blockly.selected=this;this.svg_.addSelect();Blockly.fireUiEvent(this.workspace.getCanvas(),"blocklySelectChange")};Blockly.Block.prototype.unselect=function(){Blockly.selected=null;this.svg_.removeSelect();Blockly.fireUiEvent(this.workspace.getCanvas(),"blocklySelectChange")};
...
Blockly.Block.prototype.setWarningText=function(a){if(!Blockly.Warning)throw"Warnings not supported.";var b=!1;goog.isString(a)?(this.warning||(this.warning=new Blockly.Warning(this),b=!0),this.warning.setText(a)):this.warning&&(this.warning.dispose(),b=!0);this.rendered&&(this.render(),b&&this.bumpNeighbours_())};Blockly.Block.prototype.render=function(){this.svg_.render()};Blockly.Flyout=function(){Blockly.Flyout.superClass_.constructor.call(this);this.workspace_=new Blockly.Workspace(!1)};goog.inherits(Blockly.Flyout,goog.Disposable);Blockly.Flyout.prototype.autoClose=!0;Blockly.Flyout.prototype.CORNER_RADIUS=8;Blockly.Flyout.prototype.onResizeWrapper_=null;
Blockly.Flyout.prototype.createDom=function(){this.svgGroup_=Blockly.createSvgElement("g",{},null);this.svgBackground_=Blockly.createSvgElement("path",{"class":"blocklyFlyoutBackground"},this.svgGroup_);this.svgOptions_=Blockly.createSvgElement("g",{},this.svgGroup_);this.workspace_.render(this.svgOptions_);return this.svgGroup_};
Blockly.Flyout.prototype.disposeInternal=function(){this.onResizeWrapper_&&(Blockly.unbindEvent_(this.onResizeWrapper_),this.onResizeWrapper_=null);this.scrollbar_&&(this.scrollbar_.dispose(),this.scrollbar_=null);goog.dispose(this.workspace_);this.workspace_=null;this.svgGroup_&&(goog.dom.removeNode(this.svgGroup_),this.svgGroup_=null);this.buttons_=this.targetWorkspaceMetrics_=this.targetWorkspace_=this.svgOptions_=this.svgBackground_=null;Blockly.Flyout.superClass_.disposeInternal.call(this)};
...
goog.color.colorDiff_=function(a,b){return Math.abs(a[0]-b[0])+Math.abs(a[1]-b[1])+Math.abs(a[2]-b[2])};goog.events.KeyCodes={WIN_KEY_FF_LINUX:0,MAC_ENTER:3,BACKSPACE:8,TAB:9,NUM_CENTER:12,ENTER:13,SHIFT:16,CTRL:17,ALT:18,PAUSE:19,CAPS_LOCK:20,ESC:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,PRINT_SCREEN:44,INSERT:45,DELETE:46,ZERO:48,ONE:49,TWO:50,THREE:51,FOUR:52,FIVE:53,SIX:54,SEVEN:55,EIGHT:56,NINE:57,FF_SEMICOLON:59,FF_EQUALS:61,QUESTION_MARK:63,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,
...
Blockly.clipboard_=null;Blockly.svgSize=function(){return{width:Blockly.svg.cachedWidth_,height:Blockly.svg.cachedHeight_,top:Blockly.svg.cachedTop_,left:Blockly.svg.cachedLeft_}};Blockly.svgResize=function(a){a=a?a:Blockly.svg;var b=a.parentNode.offsetWidth,c=a.parentNode.offsetHeight;a.cachedWidth_!=b&&(a.setAttribute("width",b+"px"),a.cachedWidth_=b);a.cachedHeight_!=c&&(a.setAttribute("height",c+"px"),a.cachedHeight_=c);b=a.getBoundingClientRect();a.cachedLeft_=b.left;a.cachedTop_=b.top};
...
Blockly.addChangeListener=function(a){return Blockly.bindEvent_(Blockly.mainWorkspace.getCanvas(),"blocklyWorkspaceChange",null,a)};Blockly.removeChangeListener=function(a){Blockly.unbindEvent_(a)};Blockly.cssLoaded=function(){Blockly.Field&&(Blockly.Field.textLengthCache={});Blockly.Toolbox&&Blockly.Toolbox.redraw()};
Blockly.loadCss=function(){if(Blockly.loadCss.loading_)return Blockly.loadCss.loading_;var a,b=document.head||document.getElementsByTagName("head")[0];if(b){a=new goog.async.Deferred;var c=goog.dom.createDom("link",{href:Blockly.pathToBlockly+"media/blockly.css",rel:"stylesheet",type:"text/css"});goog.events.listenOnce(c,goog.events.EventType.LOAD,function(b){a.callback(c)});Blockly.loadCss.loading_=a;b.appendChild(c)}else a=fail(Error("No head in document."));return a.addCallback(Blockly.cssLoaded)};Blockly.SvgComponent=function(){Blockly.SvgComponent.superClass_.constructor.call(this)};goog.inherits(Blockly.SvgComponent,goog.ui.Component);
Blockly.SvgComponent.prototype.createDom=function(){Blockly.loadCss();var a=Blockly.createSvgElement("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:html":"http://www.w3.org/1999/xhtml","xmlns:xlink":"http://www.w3.org/1999/xlink",version:"1.1","class":"blocklySvg"},null);this.setElementInternal(a);var a=Blockly.createSvgElement("defs",{},a),b,c;b=Blockly.createSvgElement("filter",{id:"blocklyEmboss"},a);Blockly.createSvgElement("feGaussianBlur",{"in":"SourceAlpha",stdDeviation:1,result:"blur"},
b);c=Blockly.createSvgElement("feSpecularLighting",{"in":"blur",surfaceScale:1,specularConstant:0.5,specularExponent:10,"lighting-color":"white",result:"specOut"},b);Blockly.createSvgElement("fePointLight",{x:-5E3,y:-1E4,z:2E4},c);Blockly.createSvgElement("feComposite",{"in":"specOut",in2:"SourceAlpha",operator:"in",result:"specOut"},b);Blockly.createSvgElement("feComposite",{"in":"SourceGraphic",in2:"specOut",operator:"arithmetic",k1:0,k2:1,k3:1,k4:0},b);b=Blockly.createSvgElement("filter",{id:"blocklyTrashcanShadowFilter"},
a);Blockly.createSvgElement("feGaussianBlur",{"in":"SourceAlpha",stdDeviation:2,result:"blur"},b);Blockly.createSvgElement("feOffset",{"in":"blur",dx:1,dy:1,result:"offsetBlur"},b);b=Blockly.createSvgElement("feMerge",{},b);Blockly.createSvgElement("feMergeNode",{"in":"offsetBlur"},b);Blockly.createSvgElement("feMergeNode",{"in":"SourceGraphic"},b);b=Blockly.createSvgElement("filter",{id:"blocklyShadowFilter"},a);Blockly.createSvgElement("feGaussianBlur",{stdDeviation:2},b);a=Blockly.createSvgElement("pattern",
{id:"blocklyDisabledPattern",patternUnits:"userSpaceOnUse",width:10,height:10},a);Blockly.createSvgElement("rect",{width:10,height:10,fill:"#aaa"},a);Blockly.createSvgElement("path",{d:"M 0 0 L 10 10 M 10 0 L 0 10",stroke:"#cc0"},a);this.workspace_=new Blockly.Workspace(Blockly.editable);this.addChild(this.workspace_,!0);this.widget_=goog.dom.createDom("div",{"class":"blocklyWidgetDiv"})};
Blockly.SvgComponent.prototype.enterDocument=function(){Blockly.SvgComponent.superClass_.enterDocument.call(this);var a=this.getElement(),b=a.parentElement;b.setAttribute("dir","LTR");var c=this.getSvg();Blockly.Toolbox&&Blockly.editable&&c.appendChild(Blockly.Toolbox.createDom());Blockly.Tooltip&&c.appendChild(Blockly.Tooltip.createDom());Blockly.editable&&Blockly.FieldDropdown&&c.appendChild(Blockly.FieldDropdown.createDom());Blockly.ContextMenu&&Blockly.ContextMenu&&c.appendChild(Blockly.ContextMenu.createDom());
Blockly.svgResize(a);b.appendChild(this.widget_)};Blockly.SvgComponent.prototype.getWorkspace=function(){return this.workspace_};Blockly.SvgComponent.prototype.getSvg=function(){return this.getElement()};Blockly.SvgComponent.prototype.getWidget=function(){return this.widget_};Blockly.FieldImage=function(a,b,c){this.sourceBlock_=null;c=Number(c);b=Number(b);this.size_={height:c+10,width:b};var d=6-Blockly.BlockSvg.TITLE_HEIGHT;this.group_=Blockly.createSvgElement("g",{},null);this.imageElement_=Blockly.createSvgElement("image",{height:c+"px",width:b+"px",y:d},this.group_);this.setText(a);goog.userAgent.GECKO&&(this.rectElement_=Blockly.createSvgElement("rect",{height:c+"px",width:b+"px",y:d,"fill-opacity":0},this.group_))};goog.inherits(Blockly.FieldImage,Blockly.Field);
...
Blockly.CodeGenerator.prototype.statementToCode=function(a,b){var c=a.getInputTargetBlock(b),d=this.blockToCode(c);if(!goog.isString(d))throw'Expecting code from statement block "'+c.type+'".';d&&(d=Blockly.Generator.prefixLines(d,"  "));return d};Blockly.CodeGenerator.prototype.addReservedWords=function(a){this.RESERVED_WORDS_+=a+","};Blockly.inject=function(a,b){if(!goog.dom.contains(document,a))throw"Error: container is not in current document.";b&&goog.mixin(Blockly,Blockly.parseOptions_(b));if(Blockly.inject.svgComponent_)throw"Error: Blockly already injected";Blockly.inject.svgComponent_=new Blockly.SvgComponent;Blockly.inject.svgComponent_.render(a);Blockly.mainWorkspace=Blockly.inject.svgComponent_.getWorkspace();Blockly.svg=Blockly.inject.svgComponent_.getSvg();Blockly.widgetDiv=Blockly.inject.svgComponent_.getWidget();
Blockly.init_()};Blockly.parseOptions_=function(a){return{RTL:!!a.rtl,editable:!a.readOnly,pathToBlockly:a.path||"./",Trashcan:!1===a.trashcan?void 0:Blockly.Trashcan}};
